package com.kyo.event.simpleVideo
{
	...
	public class SimpleVideoEvent extends DynamicEvent
	{
		 ...
		 * seek开始
		 */		
		public static const ON_SEEK_START:String = "onSeekStart";
		
		/**
		 * seek中
		 */		
		public static const ON_SEEKING:String = "onSeeking";
		
		/**
		 * seek完成
		 */		
		public static const ON_SEEK_COMPLETE:String = "onSeekComplete";
	}
}