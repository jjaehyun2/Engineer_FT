class ZCB_PRODUCTO_PERSIST definition
  public
  inheriting from CL_OS_CA_COMMON
  abstract
  create public .

*"* public components of class ZCB_PRODUCTO_PERSIST
...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_PRODUCTO_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_PRODUCTO_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_PRODUCTO_PERSIST .
  types:
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_PRODUCTO_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_PRODUCTO_PERSIST IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 051402
*      IMPORTING I_PRODUCTO TYPE ZBT_ID_PRODUCTO
*      RETURNING RESULT TYPE REF TO ZCL_PRODUCTO_PERSIST
************************************************************************
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_PRODUCTO_PERSIST,
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZBT_PRODUCTO'.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_PRODUCTO_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_PRODUCTO.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_PRODUCTO> type ZBT_PRODUCTO.
*>

*< Generated from mapping:
  select * from ZBT_PRODUCTO
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_PRODUCTO>.

*< Generated from mapping:
    DB_DATA-PRODUCTO = <FS_DB_ZBT_PRODUCTO>-PRODUCTO.
*>
...
*< Generated from mapping:
  select * from ZBT_PRODUCTO
           ...
           where ZBT_PRODUCTO~PRODUCTO = I_BUSINESS_KEY_TAB-PRODUCTO.
*>
...
* * ZBT_PRODUCTO: internal tables for mass operation
  data DB_ITB_ZBT_PRODUCTO type STANDARD TABLE OF ZBT_PRODUCTO.
  data DB_UTB_ZBT_PRODUCTO type STANDARD TABLE OF ZBT_PRODUCTO.
  data DB_DTB_ZBT_PRODUCTO type STANDARD TABLE OF ZBT_PRODUCTO.

* * ZBT_PRODUCTO: headlines for tables
  data DB_ILN_ZBT_PRODUCTO type ZBT_PRODUCTO.
  data DB_ULN_ZBT_PRODUCTO type ZBT_PRODUCTO.
  data DB_DLN_ZBT_PRODUCTO type ZBT_PRODUCTO.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_PRODUCTO-PRODUCTO = <FS_INSERT>-PRODUCTO.
   append DB_ILN_ZBT_PRODUCTO to DB_ITB_ZBT_PRODUCTO.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_PRODUCTO-PRODUCTO = <FS_UPDATE>-PRODUCTO.
   append DB_ULN_ZBT_PRODUCTO TO DB_UTB_ZBT_PRODUCTO.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_PRODUCTO-PRODUCTO = <FS_DELETE>-BUSINESS_KEY-PRODUCTO.

    append DB_DLN_ZBT_PRODUCTO TO DB_DTB_ZBT_PRODUCTO.
...
* * DB Deletes
  delete ZBT_PRODUCTO FROM TABLE DB_DTB_ZBT_PRODUCTO.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZBT_PRODUCTO FROM TABLE DB_ITB_ZBT_PRODUCTO
...
* * DB Updates
  update ZBT_PRODUCTO FROM TABLE DB_UTB_ZBT_PRODUCTO.
  if SY-SUBRC <> 0.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_PRODUCTO_PERSIST.
