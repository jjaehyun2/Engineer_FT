class ZCB_ESTADO_PERSIST definition
  public
...
public section.
*"* public components of class ZCB_ESTADO_PERSIST
*"* do not include other source files here!!!
  ...
  methods CREATE_PERSISTENT
    importing
      ...
      !I_TYPE type ZBT_TYPESTATUS optional
      !I_WDAICON type ZBT_ESTADO_ICON_WDA optional
    returning
      value(RESULT) type ref to ZCL_ESTADO_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_ESTADO_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_ESTADO_PERSIST .
  types:
  ...
  types:
    begin of TYP_DB_DATA ,
      ...
      WDAICON type ZBT_ESTADO_ICON_WDA ,
    end of TYP_DB_DATA .
  types:
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_ESTADO_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_ESTADO_PERSIST IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_ESTADO TYPE ZBT_ID_ESTADO
*      IMPORTING I_ICON TYPE ICONNAME
*      IMPORTING I_TYPE TYPE ZBT_TYPESTATUS
*      IMPORTING I_WDAICON TYPE ZBT_ESTADO_ICON_WDA
*      RETURNING RESULT TYPE REF TO ZCL_ESTADO_PERSIST
************************************************************************
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_ESTADO_PERSIST,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-WDAICON = THE_OBJECT->WDAICON.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZBT_ESTADO'.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'WDAICON'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_ESTADO'.
    MAP_ATT_INFO-FIELD_NAME1  = 'WDAICON'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_ESTADO_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_ESTADO.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_ESTADO> type ZBT_ESTADO.
*>

*< Generated from mapping:
  select * from ZBT_ESTADO
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_ESTADO>.

*< Generated from mapping:
    DB_DATA-ESTADO = <FS_DB_ZBT_ESTADO>-ESTADO.
    DB_DATA-ICON = <FS_DB_ZBT_ESTADO>-ICON.
    DB_DATA-TYPE = <FS_DB_ZBT_ESTADO>-TYPE.
    DB_DATA-WDAICON = <FS_DB_ZBT_ESTADO>-WDAICON.
*>
...
*< Generated from mapping:
  select * from ZBT_ESTADO
           ...
           where ZBT_ESTADO~ESTADO = I_BUSINESS_KEY_TAB-ESTADO.
*>
...
* * ZBT_ESTADO: internal tables for mass operation
  data DB_ITB_ZBT_ESTADO type STANDARD TABLE OF ZBT_ESTADO.
  data DB_UTB_ZBT_ESTADO type STANDARD TABLE OF ZBT_ESTADO.
  data DB_DTB_ZBT_ESTADO type STANDARD TABLE OF ZBT_ESTADO.

* * ZBT_ESTADO: headlines for tables
  data DB_ILN_ZBT_ESTADO type ZBT_ESTADO.
  data DB_ULN_ZBT_ESTADO type ZBT_ESTADO.
  data DB_DLN_ZBT_ESTADO type ZBT_ESTADO.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_ESTADO-ICON = <FS_INSERT>-ICON.
   DB_ILN_ZBT_ESTADO-TYPE = <FS_INSERT>-TYPE.
   DB_ILN_ZBT_ESTADO-WDAICON = <FS_INSERT>-WDAICON.


   DB_ILN_ZBT_ESTADO-ESTADO = <FS_INSERT>-ESTADO.
   append DB_ILN_ZBT_ESTADO to DB_ITB_ZBT_ESTADO.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_ESTADO-ICON = <FS_UPDATE>-ICON.
   DB_ULN_ZBT_ESTADO-TYPE = <FS_UPDATE>-TYPE.
   DB_ULN_ZBT_ESTADO-WDAICON = <FS_UPDATE>-WDAICON.


   DB_ULN_ZBT_ESTADO-ESTADO = <FS_UPDATE>-ESTADO.
   append DB_ULN_ZBT_ESTADO TO DB_UTB_ZBT_ESTADO.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_ESTADO-ESTADO = <FS_DELETE>-BUSINESS_KEY-ESTADO.

    append DB_DLN_ZBT_ESTADO TO DB_DTB_ZBT_ESTADO.
...
* * DB Deletes
  delete ZBT_ESTADO FROM TABLE DB_DTB_ZBT_ESTADO.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZBT_ESTADO FROM TABLE DB_ITB_ZBT_ESTADO
...
* * DB Updates
  update ZBT_ESTADO FROM TABLE DB_UTB_ZBT_ESTADO.
  if SY-SUBRC <> 0.
...
*<  Generated from mapping:
  ...
  THE_OBJECT->WDAICON = I_OBJECT_DATA-WDAICON.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_ESTADO_PERSIST.
