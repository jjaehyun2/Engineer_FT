package
{
	import com.adobe.media.SphericalVideo3;
	...
	public class SphericalVideoSamplePlayer_me3 extends Sprite
	{
...
//		private static const FILE_NAME:String = "file:///H:/%E6%95%99%E7%A8%8B/360degree%E8%A7%86%E9%A2%91/3840x2160/360%20Google%20Spotlight%20Story-%20HELP.mp4";
		private static const FILE_NAME:String = "file:///H:/教程/360degree视频/3840x2160/Ocean Descent VR 360 - YouTube.MP4";// 3840x1920
//		private static const FILE_NAME:String = "file:///H:/教程/360degree视频/1920x1080/PlayStation VR Worlds- Ocean Descent - 360 Grad-Trailer [PlayStation VR] - YouTube_2.MP4";// 3840x1920
...
//		private static const 
		...
		private var sphericalVideo:SphericalVideo3;
...
//		private var 
		...
		public function SphericalVideoSamplePlayer_me3()
		{
...
//			stage.scaleMode = StageScaleMode.NO_SCALE;
			...
			sphericalVideo = new SphericalVideo3(stage, 0, 0, 960, 540);
			sphericalVideo.addEventListener(SphericalVideo3.AVAILABLE, onSphericalVideoAvailable);
...
//			sphericalVideo = new SphericalVideo3(stage, 0, 0, 960, 540);
//			sphericalVideo = new SphericalVideo3(stage, 0, 0, info.width, info.height);
//			sphericalVideo.addEventListener(SphericalVideo3.AVAILABLE, onSphericalVideoAvailable);
			sphericalVideo.setBufferSize(info.width, info.height);
		/*	sphericalVideo.setProjectionType();
			sphericalVideo.setFOV(fov, zNear, zFar);*/
