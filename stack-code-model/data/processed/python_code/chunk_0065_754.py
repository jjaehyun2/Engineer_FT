package qihoo.triplecleangame.protos {
	...
	public dynamic final class CMsgAcceptRequestGiftRequest extends com.netease.protobuf.Message {
		public static const USERQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgAcceptRequestGiftRequest.userQID", "userQID", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const FRIENDQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgAcceptRequestGiftRequest.friendQID", "friendQID", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const REQUESTTYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgAcceptRequestGiftRequest.requestType", "requestType", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgAcceptRequestGiftRequest.id", "id", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const REQUESTNUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgAcceptRequestGiftRequest.requestNum", "requestNum", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const ACCEPT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgAcceptRequestGiftRequest.accept", "accept", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (userQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgAcceptRequestGiftRequest.userQID cannot be set twice.');
					}
					++userQID$count;
				...
				case 2:
					if (friendQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgAcceptRequestGiftRequest.friendQID cannot be set twice.');
					}
					++friendQID$count;
				...
				case 3:
					if (requestType$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgAcceptRequestGiftRequest.requestType cannot be set twice.');
					}
					++requestType$count;
				...
				case 4:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgAcceptRequestGiftRequest.id cannot be set twice.');
					}
					++id$count;
				...
				case 5:
					if (requestNum$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgAcceptRequestGiftRequest.requestNum cannot be set twice.');
					}
					++requestNum$count;
				...
				case 6:
					if (accept$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgAcceptRequestGiftRequest.accept cannot be set twice.');
					}
					++accept$count;
