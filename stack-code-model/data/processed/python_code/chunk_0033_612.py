...
package com.neopets.projects.support.shell
{
	...
	public class NeopetsShell extends NeopetsShellSupport
	{
		...
		public function NeopetsShell():void
		{
		...
		public function sceneEffect(pActiveScene:NeopetsScene,pEffect:String = null):void
		{
			...
			else
			{
				...
				var newViewC:ViewContainerold = pActiveScene.viewContainer;
		...
		{	
			...
			mViewContainer = new ViewContainerold(ID + "_VC");
			mButtonLock = false;
