...
public class SliderThumbIcon implements Icon, UIResource{
	...
	protected var enabledButton:JButton;
	protected var disabledButton:JButton;
	protected var overButton:JButton;
	...
	protected function initThumb(c:Component):void{
		//enabled
		enabledButton = new JButton();
		var upState:Shape = new Shape();
		var g:Graphics2D = new Graphics2D(new Graphics(upState));
    	paintThumb(g, c, true, false);
		var overState:Shape = new Shape();
		g = new Graphics2D(new Graphics(overState));
