...
//		}
	...
	// Designer: Added to activate the About menu
	public function showAboutMenu(b:*):void {
		showAboutDialog();
	}
	...
	private var frameRateReadout:TextField = null;
	...
	protected function removeFrameRateReadout():void {
		if(frameRateReadout != null) {
			frameRateReadout.removeEventListener(Event.ENTER_FRAME, updateFrameRate);
			removeChild(frameRateReadout);
			frameRateReadout = null;
