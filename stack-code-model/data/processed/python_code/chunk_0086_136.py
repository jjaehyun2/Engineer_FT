...
package com.neopets.projects.effects.particle
{
	...
	public class ImageManager
	{
		...
		private var mSkipFilter:Boolean = true	// set this true for much faster processing power
		...
		public static function get skipFilter():Boolean
		{
			return ImageManager.instance.mSkipFilter
		}
		
		public static function set skipFilter(pB:Boolean):void
		{
			ImageManager.instance.mSkipFilter  = pB
		}
		...
		public static function showParticles():void
		{
			...
			if (!ImageManager.instance.mSkipFilter) ImageManager.instance.applyFilters();	// apply filters to each bitmap--takes a lot of processing power...
		...
		public static function resetHolders():void
		{
			...
			ImageManager.instance.refreshBitmaps();
