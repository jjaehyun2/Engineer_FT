...
package SJ.Game.data.json
{
	...
	public class Json_pk_show extends SDataBaseJson
	{
		public function Json_pk_show()
		{
		}
		...
		private var _extinfo:* = null;
		public function get extinfo():*{return _extinfo;}
		public function set extinfo(value:*):void{_extinfo=value;}
