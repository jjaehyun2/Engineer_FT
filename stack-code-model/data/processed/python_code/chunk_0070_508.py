...
{
	import com.neopets.games.inhouse.SuperSearch.Spinbrush.SpinbrushSuperSearch_Translation;
	...
	import com.neopets.games.inhouse.SuperSearch.Spinbrush.SpinbrushSuperSearch_Engine;
	...
	public class SpinbrushSuperSearch_Document extends NP9_DocumentExtension
	{
		...
		private var mGameEngineDemo:SpinbrushSuperSearch_Engine;
		protected var mGameShell_Events:GameShell_Events;
		protected var mTranslationData:SpinbrushSuperSearch_Translation;
		...
		public function SpinbrushSuperSearch_Document():void{
		...
		**/
		...
		protected override function gameEngineUpdate():void
		{
			...
			mGameEngineDemo.init(this,mcBIOS.finalPathway, mTranslationData);	
		...
		{
			mGameEngineDemo = new SpinbrushSuperSearch_Engine();
			...
			mcBIOS.game_id =  1232; 														//This Number will be provided by Neopets, For Demo it's 13000, GameEngineTest is 1105
			mcBIOS.game_lang = "en"; 														//Do Not Change
			mcBIOS.meterX = 120;															//This will be the location of the Score Reporting Window From Neopets
			mcBIOS.meterY = 300;   															//This will be the location of the Score Reporting Window From Neopets
			...
			mTranslationData = new SpinbrushSuperSearch_Translation();
