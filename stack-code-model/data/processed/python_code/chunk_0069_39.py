package qihoo.triplecleangame.protos {
	...
	public dynamic final class PBGetGiftArray extends com.netease.protobuf.Message {
		public static const USERQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.PBGetGiftArray.userQID", "userQID", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const FRIENDQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.PBGetGiftArray.friendQID", "friendQID", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const REQUESTTYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.PBGetGiftArray.requestType", "requestType", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.PBGetGiftArray.id", "id", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const REQUESTNUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.PBGetGiftArray.requestNum", "requestNum", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (userQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: PBGetGiftArray.userQID cannot be set twice.');
					}
					++userQID$count;
				...
				case 2:
					if (friendQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: PBGetGiftArray.friendQID cannot be set twice.');
					}
					++friendQID$count;
				...
				case 3:
					if (requestType$count != 0) {
						throw new flash.errors.IOError('Bad data format: PBGetGiftArray.requestType cannot be set twice.');
					}
					++requestType$count;
				...
				case 4:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: PBGetGiftArray.id cannot be set twice.');
					}
					++id$count;
				...
				case 5:
					if (requestNum$count != 0) {
						throw new flash.errors.IOError('Bad data format: PBGetGiftArray.requestNum cannot be set twice.');
					}
					++requestNum$count;
