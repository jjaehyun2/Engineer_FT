package tetragon.view.render2d.extensions.graphics
{
	...
	public class Stroke2D extends Graphic2D
	{
		...
		public function addVertex(x:Number, y:Number, thickness:Number = 1, color0:uint = 0xFFFFFF,
			alpha0:Number = 1, color1:uint = 0xFFFFFF, alpha1:Number = 1):void
		{
			var u:Number = 0;
			var textures:Vector.<Texture2D> = _material.textures;
		...
		// // ///////////////////////////////
		private static function createPolyLine(vertices:Vector.<StrokeVertex>, closed:Boolean,
			outputVertices:Vector.<Number>, outputIndices:Vector.<uint>):void
		{
		...
		static public function intersection(a0x:Number, a0y:Number, a1x:Number, a1y:Number,
			b0x:Number, b0y:Number, b1x:Number, b1y:Number):Array
		{
...
internal class StrokeVertex
{
	...
	public function StrokeVertex(x:Number = 0, y:Number = 0, z:Number = 0, r:Number = 1,
		g:Number = 1, b:Number = 1, a:Number = 1, r2:Number = 1, g2:Number = 1, b2:Number = 1,
		a2:Number = 1, u:Number = 0, v:Number = 0, thickness:Number = 1)
	{
		this.x = x;
		this.y = y;
		this.z = z;
