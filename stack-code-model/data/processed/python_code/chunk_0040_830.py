...
public class ToolTipManager extends EventDispatcher
{
	...
	/*modified*/
	public static function showImmediately( target:DisplayObject):void
	{
		impl.showImmediately( target );
	}	
	/*modified*/
	
	/*modified*/
	public static function hideImmediately() : void
	{
		impl.hideImmediately();
	}
	/*modified*/
	public static function updatePos() : void
	{
		impl.updatePos();
	}
}
