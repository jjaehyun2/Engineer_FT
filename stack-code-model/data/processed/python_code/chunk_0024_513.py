...
package com.neopets.examples.gameEngineExample
{
	...
	public class GameEngineDemo_Document extends NP9_DocumentExtension
	{
		...
		public function GameEngineDemo_Document():void{
		...
		**/
		...
		private function setupVars():void
		{
			...
			mcBIOS.game_server = "images.neopets.com"; 									// Changed to work remotely
			...
			mcBIOS.game_datestamp =  "10/12/10";								//for testing only
