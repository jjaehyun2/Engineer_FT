...
package com.neopets.games.marketing.destination.CapriSun2011.subElements
{
	...
	public class SixFlags2010SmallPopup extends MovieClip
	{
		//--------------------------------------
		// CLASS CONSTANTS
		//--------------------------------------
		...
		public function SixFlags2010SmallPopup()
		{
			super();
			//close_btn.addEventListener(MouseEvent., closePopUp, false, 0, true);
