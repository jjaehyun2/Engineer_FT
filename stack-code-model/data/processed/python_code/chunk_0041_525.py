...
package com.neopets.projects.destination.videoPlayerComponent
{
	...
	public class VideoPlayerSingleton extends Sprite {
		...
		public function setVideoParam(pRoot:Object, pVideoPlayerClass:String, pSourceURLHigh:String, pSourceURLLow:String = null, px:Number = 0, py:Number = 0, pClickID:int = 0):void
		{
