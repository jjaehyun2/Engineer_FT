...
class Map.MapMarker extends gfx.controls.Button
{
  /* CONSTANTS */
	...
	private static var ICON_MAP: Array = ["EmptyMarker", "CityMarker", "TownMarker", "SettlementMarker", "CaveMarker", 
										  "CampMarker", "FortMarker", "NordicRuinMarker", "DwemerMarker", 
										  "ShipwreckMarker", "GroveMarker", "LandmarkMarker", "DragonlairMarker", 
										  "FarmMarker", "WoodMillMarker", "MineMarker", "ImperialCampMarker", 
										  "StormcloakCampMarker", "DoomstoneMarker", "WheatMillMarker", "SmelterMarker", 
										  "StableMarker", "ImperialTowerMarker", "ClearingMarker", "PassMarker",
										  "AltarMarker", "RockMarker", "LighthouseMarker", "OrcStrongholdMarker", 
										  "GiantCampMarker", "ShackMarker", "NordicTowerMarker", "NordicDwellingMarker", 
										  "DocksMarker", "ShrineMarker", "RiftenCastleMarker", "RiftenCapitolMarker", 
										  "WindhelmCastleMarker", "WindhelmCapitolMarker", "WhiterunCastleMarker",
										  "WhiterunCapitolMarker", "SolitudeCastleMarker", "SolitudeCapitolMarker", 
										  "MarkarthCastleMarker", "MarkarthCapitolMarker", "WinterholdCastleMarker", 
										  "WinterholdCapitolMarker", "MorthalCastleMarker", "MorthalCapitolMarker", 
										  "FalkreathCastleMarker", "FalkreathCapitolMarker", "DawnstarCastleMarker", 
										  "DawnstarCapitolMarker", "DLC02MiraakTempleMarker", "DLC02RavenRockMarker",
										  "DLC02StandingStonesMarker", "DLC02TelvanniTowerMarker", "DLC02ToSkyrimMarker", 
										  "DLC02ToSolstheimMarker", "DLC02CastleKarstaagMarker", "", "DoorMarker", 
										  "QuestTargetMarker", "QuestTargetDoorMarker", "MultipleQuestTargetMarker",
										  "PlayerSetMarker", "YouAreHereMarker", "TownIndorilMarker", "AshlanderCampMarker", 
										  "TownImperialMarker", "MWFortMarker", "MWDwemerRuinsMarker", 
										  "MWDaedricRuinsMarker", "MWFarmMarker","AncestralTombMarker", "GrottoMarker", 
										  "MWCaveMarker","VelothiTowerMarker", "MWShipwreckMarker", 
										  "DunmerStrongholdMarker", "EbonheartCapitalMarker", "AldruhnCapitalMarker", 
										  "SadrithMoraCapitalMarker", "BalmoraCapitalMarker", "VivecCapitalMarker", 
										  "TownRedoranMarker", "TownTelvanniMarker", "MWMineMarker", "MWEggMineMarker", 
										  "MWNetchFarmMarker", "MWVillageMarker", "MWShrineMarker", "TownHlaaluMarker" ];

	private static var UNDISCOVERED_OFFSET: Number = 100;
  ...
  /* INITIALIZATION */
	...
	public function configUI(): Void
	{
		...
		switch (_iconName) {
			...
			case "WoodMillMarker":
			case "MWFarmMarker":
			case "MWNetchFarmMarker":
			case "MWEggMineMarker":
			case "MWVillageMarker":
			case "MWShrineMarker":
			case "MWMineMarker":
			...
			case "TownImperialMarker":
			case "CityMarker":
			case "TownMarker":
				_markerSize += _markerSize/3 + 1;
				break;
			...
			case "VivecCapitalMarker":
			case "SadrithMoraCapitalMarker":
			case "BalmoraCapitalMarker":
			case "AldruhnCapitalMarker":
			case "EbonheartCapitalMarker":
