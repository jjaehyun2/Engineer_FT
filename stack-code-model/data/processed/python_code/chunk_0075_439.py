package com.audioengine.format.wav
{
	...
	public final class WAVEncoder extends PCMEncoder
	{
		...
		override protected function writeHeader( bytes: ByteArray ) : void
		{
			...
			var compressionType : int = strategy.compressionType is Array ? int( strategy.compressionType[ 0 ] ) : int( strategy.compressionType ); 
			
			bytes.writeShort( compressionType ); // compression
