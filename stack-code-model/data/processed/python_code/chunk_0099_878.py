package arsupport.demo.away3dlite
{
	 ...
	 */
	public class RainbowAR extends ARAway3DLiteContainer
	{
		
		[Embed(source = "../../../../assets/rainbow/rainbow_dash_body.png")] private static var bodyTexture:Class;
		[Embed(source = "../../../../assets/rainbow/rainbow_dash_eyes.png")] private static var eyesTexture:Class;
		[Embed(source = "../../../../assets/rainbow/rainbow_dash_hair_front.png")] private static var hairFrontTexture:Class;
		[Embed(source = "../../../../assets/rainbow/rainbow_dash_hair_back.png")] private static var hairBackTexture:Class;
		[Embed(source = "../../../../assets/rainbow/rainbow_dash_tail.png")] private static var tailTexture:Class;
		[Embed(source = "../../../../assets/rainbow/rainbow_dash_wings.png")] private static var wingdTexture:Class;
		
		//[Embed(source = "../../../../assets/rainbow/model.dae", mimeType = "application/octet-stream")] private static var Charmesh:Class;
		[Embed(source="../../../../assets/rainbow/model.zip", mimeType="application/octet-stream")] private static var modelZip:Class;
		...
		public function RainbowAR(world3d:World3D)
		{
			super();
