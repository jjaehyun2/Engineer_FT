...
inheriting from zcl_assert.
  ...
  "Difference between this and full update:
   "it doesn't delete records that are not on the result set
   "it still remove entries for tadir records flagged as delete
  private section.
...
class ltc_results_db implementation.
  ...
  method reset_instances.
    ...
    cut = new zcl_adash_light_db_update(  ).
