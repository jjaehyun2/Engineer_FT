class ZCL_BUG_ESTHOURS_PERSIST definition
  public
  final
  create protected

  global friends ZCB_BUG_ESTHOURS_PERSIST .

public section.
*"* public components of class ZCL_BUG_ESTHOURS_PERSIST
*"* do not include other source files here!!!
  ...
  methods SET_ESTHOURS
    importing
      !I_ESTHOURS type ZBT_HORAS_ESTIMADAS
    raising
      CX_OS_OBJECT_NOT_FOUND .
  class CL_OS_SYSTEM definition load .
protected section.
*"* protected components of class ZCL_BUG_ESTHOURS_PERSIST
*"* do not include other source files here!!!
...
private section.
*"* private components of class ZCL_BUG_ESTHOURS_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_BUG_ESTHOURS_PERSIST IMPLEMENTATION.
...
***BUILD 090501
     ...
     " raising CX_OS_OBJECT_NOT_FOUND
************************************************************************
* Purpose        : Get Attribute ESTHOURS
*
* Version        : 2.0
*
* Precondition   : -
...
method SET_ESTHOURS.
***BUILD 090501
     " importing I_ESTHOURS
     " raising CX_OS_OBJECT_NOT_FOUND
************************************************************************
* Purpose        : Set attribute ESTHOURS
*
* Version        : 2.0
*
* Precondition   : -
