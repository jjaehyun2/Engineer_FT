class ZCB_BUG_TAG_PERSIST definition
  public
...
public section.
*"* public components of class ZCB_BUG_TAG_PERSIST
*"* do not include other source files here!!!
  ...
  methods CREATE_PERSISTENT
    importing
      ...
      !I_TAG type ZBT_ID_TAG
    returning
      value(RESULT) type ref to ZCL_BUG_TAG_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_BUG_TAG_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_BUG_TAG_PERSIST .
  types:
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_BUG_TAG_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_BUG_TAG_PERSIST IMPLEMENTATION.
...
*      IMPORTING I_TAG TYPE ZBT_ID_TAG
*      RETURNING RESULT TYPE REF TO ZCL_BUG_TAG_PERSIST
************************************************************************
...
*<Generated from mapping:
  ...
  E_BUSINESS_KEY-TAG  = I_DB_DATA-TAG.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_BUG_TAG_PERSIST,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-TAG = THE_OBJECT->TAG.
    OBJECT_DATA_ITEM-TAGVAL = THE_OBJECT->TAGVAL.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_TAG'.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'TAG'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_TAG'.
    MAP_ATT_INFO-FIELD_NAME1  = 'TAG'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'TAGVAL'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_TAG'.
    MAP_ATT_INFO-FIELD_NAME1  = 'TAGVAL'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_BUG_TAG_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_BUG_TAG.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_BUG_TAG> type ZBT_BUG_TAG.
*>

*< Generated from mapping:
  select * from ZBT_BUG_TAG
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_BUG_TAG>.

*< Generated from mapping:
    DB_DATA-PRODUCTO = <FS_DB_ZBT_BUG_TAG>-PRODUCTO.
    DB_DATA-BUG = <FS_DB_ZBT_BUG_TAG>-BUG.
    DB_DATA-TAG = <FS_DB_ZBT_BUG_TAG>-TAG.
    DB_DATA-TAGVAL = <FS_DB_ZBT_BUG_TAG>-TAGVAL.
*>
...
*< Generated from mapping:
  select * from ZBT_BUG_TAG
           ...
           where ZBT_BUG_TAG~PRODUCTO = I_BUSINESS_KEY_TAB-PRODUCTO
             and ZBT_BUG_TAG~BUG = I_BUSINESS_KEY_TAB-BUG
             and ZBT_BUG_TAG~TAG = I_BUSINESS_KEY_TAB-TAG.
*>
...
*<  Generated from mapping:
    ...
    <FS_OBJECT_DATA>-TAG = BUSINESS_KEY-TAG.
*>
...
* * ZBT_BUG_TAG: internal tables for mass operation
  data DB_ITB_ZBT_BUG_TAG type STANDARD TABLE OF ZBT_BUG_TAG.
  data DB_UTB_ZBT_BUG_TAG type STANDARD TABLE OF ZBT_BUG_TAG.
  data DB_DTB_ZBT_BUG_TAG type STANDARD TABLE OF ZBT_BUG_TAG.

* * ZBT_BUG_TAG: headlines for tables
  data DB_ILN_ZBT_BUG_TAG type ZBT_BUG_TAG.
  data DB_ULN_ZBT_BUG_TAG type ZBT_BUG_TAG.
  data DB_DLN_ZBT_BUG_TAG type ZBT_BUG_TAG.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_BUG_TAG-TAGVAL = <FS_INSERT>-TAGVAL.


   DB_ILN_ZBT_BUG_TAG-PRODUCTO = <FS_INSERT>-PRODUCTO.
   DB_ILN_ZBT_BUG_TAG-BUG = <FS_INSERT>-BUG.
   DB_ILN_ZBT_BUG_TAG-TAG = <FS_INSERT>-TAG.
   append DB_ILN_ZBT_BUG_TAG to DB_ITB_ZBT_BUG_TAG.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_BUG_TAG-TAGVAL = <FS_UPDATE>-TAGVAL.


   DB_ULN_ZBT_BUG_TAG-PRODUCTO = <FS_UPDATE>-PRODUCTO.
   DB_ULN_ZBT_BUG_TAG-BUG = <FS_UPDATE>-BUG.
   DB_ULN_ZBT_BUG_TAG-TAG = <FS_UPDATE>-TAG.
   append DB_ULN_ZBT_BUG_TAG TO DB_UTB_ZBT_BUG_TAG.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_BUG_TAG-PRODUCTO = <FS_DELETE>-BUSINESS_KEY-PRODUCTO.
    DB_DLN_ZBT_BUG_TAG-BUG = <FS_DELETE>-BUSINESS_KEY-BUG.
    DB_DLN_ZBT_BUG_TAG-TAG = <FS_DELETE>-BUSINESS_KEY-TAG.

    append DB_DLN_ZBT_BUG_TAG TO DB_DTB_ZBT_BUG_TAG.
...
* * DB Deletes
  delete ZBT_BUG_TAG FROM TABLE DB_DTB_ZBT_BUG_TAG.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZBT_BUG_TAG FROM TABLE DB_ITB_ZBT_BUG_TAG
...
* * DB Updates
  update ZBT_BUG_TAG FROM TABLE DB_UTB_ZBT_BUG_TAG.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  ...
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-TAG.
  concatenate RESULT COMP_STRING into RESULT.
*>
...
*<  Generated from mapping:
  ...
  THE_OBJECT->TAG = I_OBJECT_DATA-TAG.
  THE_OBJECT->TAGVAL = I_OBJECT_DATA-TAGVAL.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_BUG_TAG_PERSIST.
...
* < Generated from mapping:
  ...
  NEW_OBJECT->TAG = I_BUSINESS_KEY-TAG.
* >
