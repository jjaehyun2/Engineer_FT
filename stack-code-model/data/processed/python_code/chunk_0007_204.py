class ZCL_COMPONENTE_PERSIST definition
  public
  final
  create protected

  global friends ZCB_COMPONENTE_PERSIST .

*"* public components of class ZCL_COMPONENTE_PERSIST
...
protected section.
*"* protected components of class ZCL_COMPONENTE_PERSIST
*"* do not include other source files here!!!

  data COMPONENTE type ZBT_ID_COMPONENTE .
  data PRODUCTO type ZBT_ID_PRODUCTO .
private section.
*"* private components of class ZCL_COMPONENTE_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_COMPONENTE_PERSIST IMPLEMENTATION.
