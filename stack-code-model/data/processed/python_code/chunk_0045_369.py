...
package feathers.controls
{
	 ...
	 *
	 * Meant as a workaround component for when TextFieldTextRenderer runs
	 * into the runtime texture limits.
	 *
	 * Since this component is rendered with the runtime's software renderer,
	...
	public class ScrollText extends Scroller
	{
		...
		/**
		 * The text to display. If `isHTML` is `true`, the
		 * text will be rendered as HTML with the same capabilities as the
		 * `htmlText` property of `flash.text.TextField`.
		 *
		 * @see #isHTML
