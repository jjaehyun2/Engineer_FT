package com.rockdot.core.model {
	...
	public class Markets 
	{
		...
		//EAST
		public static const ESTLAND   		: String = "EE";
		...
		public static const ARABIA  : String = "AR";
