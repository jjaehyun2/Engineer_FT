...
public class SpriteThumbnail extends Sprite {
	...
	private function addFrame():void {
        ...
        g.lineStyle(2, 0xEDEFF1, 1, true);
        g.beginFill(0xFFFFFF);
		g.drawRoundRect(0, 0, frameW, frameH, 5, 5);
		g.endFill();
		addChild(frame);
	}
	...
	private function addSelectedFrame():void {
		...
		g.lineStyle(2, 0x5196FD, 1, true);
		g.beginFill(0xFFFFFF);
		g.drawRoundRect(0, 0, frameW, h, 5, 5);
        g.endFill()
        g.beginFill(0x5196FD);
        g.drawRoundRectComplex(0, 57, frameW, h - 57, 0, 0, 5, 5)
		g.endFill();
