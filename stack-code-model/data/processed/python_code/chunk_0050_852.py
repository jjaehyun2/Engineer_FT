	...
	public class TextView extends Sprite
	{
		...
		public function getTextField():TextField
		{
			if (null === _textField) {
				...
				_defaultFormat = new TextFormat(FONT_NAME,FONT_SIZE);
		...
		protected function getTextFormat():TextFormat
		{
			if (null === _textFormat) 
			{
				if(null === _defaultFormat) _defaultFormat = new TextFormat(FONT_NAME,FONT_SIZE);
				_textFormat = _defaultFormat;
			}
			return _textFormat;
		}
		...
		{
			if (null === _hitArea) _hitArea = new Sprite();
			return _hitArea;
		}
