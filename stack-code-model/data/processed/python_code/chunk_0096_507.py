...
package org.aswing.dnd
{
	...
	public class DragManager
	{
		 ...
		 * @see devoron.aswing3d.AsWingManager#getRoot()
		 */
		...
		private function onTouch(e:TouchEvent):void
		{
			...
			if (touch)
			{
				...
				{
					__onMouseMove(touch.globalX, touch.globalY);
				}
			}
		 ...
		 * @see devoron.aswing3d.dnd.DropMotion
		 * @see devoron.aswing3d.dnd.DirectlyRemoveMotion
		 * @see devoron.aswing3d.dnd.RejectedMotion
		 * @see devoron.aswing3d.dnd.DragListener#onDragDrop()
		 */
		 ...
		 */
		public static function getDropTargetComponent(pos:flash.geom.Point = null):Component
		{
		 ...
		 */
		public static function getDropTragetDropTriggerComponent(pos:flash.geom.Point = null):Component
		{
		 ...
		 * @return drop target
		 */
		public static function getDropTarget(stage:Stage, pos:flash.geom.Point = null, targetType:Class = null, addtionCheck:Function = null):DisplayObject
		{
			if (stage == null)
			{
				return null;
		...
		private static function __onMouseMove(globalX:Number, globalY:Number):void
		{
			onMouseMove(globalX, globalY);
			//curStage.st
		}
		
		private static function __onMouseUp():void
		{
			drop();
		}
