class ZCL_ESTADO_PERSIST definition
  public
  final
  create protected

  global friends ZCB_ESTADO_PERSIST .

public section.
*"* public components of class ZCL_ESTADO_PERSIST
*"* do not include other source files here!!!
  ...
  methods GET_ICON
    returning
      value(RESULT) type ICONNAME
    raising
      CX_OS_OBJECT_NOT_FOUND .
  methods GET_TYPE
    returning
      value(RESULT) type ZBT_TYPESTATUS
    raising
      CX_OS_OBJECT_NOT_FOUND .
  methods GET_WDAICON
    returning
      value(RESULT) type ZBT_ESTADO_ICON_WDA
    raising
      CX_OS_OBJECT_NOT_FOUND .
  methods SET_ICON
    importing
  ...
  methods SET_TYPE
    importing
      !I_TYPE type ZBT_TYPESTATUS
    raising
      CX_OS_OBJECT_NOT_FOUND .
  methods SET_WDAICON
    importing
      !I_WDAICON type ZBT_ESTADO_ICON_WDA
    raising
      CX_OS_OBJECT_NOT_FOUND .
  class CL_OS_SYSTEM definition load .
protected section.
*"* protected components of class ZCL_ESTADO_PERSIST
*"* do not include other source files here!!!

  data ESTADO type ZBT_ID_ESTADO .
  data ICON type ICONNAME .
  data TYPE type ZBT_TYPESTATUS .
  data WDAICON type ZBT_ESTADO_ICON_WDA .
private section.
*"* private components of class ZCL_ESTADO_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_ESTADO_PERSIST IMPLEMENTATION.
