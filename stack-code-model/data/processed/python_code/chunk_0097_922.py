...
public class DragManagerImpl extends EventDispatcher implements IDragManager
{
			...
			dontProcessRelatedObjectEvents : Boolean = true ) : void
	{
		...
		dragProxy = new DragProxy(dragInitiator, dragSource, dontProcessRelatedObjectEvents );
        ...
        var concatenatedMatrix:Matrix = MatrixUtil.getConcatenatedMatrix(DisplayObject(dragInitiator),null);
