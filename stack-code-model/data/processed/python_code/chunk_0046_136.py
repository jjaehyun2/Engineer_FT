package _-E4
{
   ...
   import _-Cn._-8f;
   import game._-AB;
   import fla.maps.Map_02;
   
   public class Level1 extends _-3m
   {
      ...
      public function Level1()
      {
         ...
         if(!(_loc1_ && (_loc2_)))
         {
            this._-FJ = Level1_carWaypointsInitData;
            this.final = Level1_humanWaypointsInitData;
            if(_loc2_)
            {
            }
            this._-J0 = new Vector.<_-8f>();
            if(_loc2_ || (_loc1_))
            {
               super();
               if(_loc1_)
         ...
         this._-3A = new Vector.<_-1A>();
         if(_loc2_ || (_loc1_))
         {
            this._-Iq = new Vector.<_-JC>();
            if(_loc2_ || (_loc1_))
            {
               this._-J0 = new Vector.<_-8f>();
               if(_loc2_ || (_loc1_))
      ...
      public function _-2l(param1:Array) : void
      {
         var _loc4_:* = false;
         var _loc5_:* = true;
         ...
         {
            _loc3_ = param1[_loc2_].body;
            if(_loc5_ || (_loc2_))
            {
               _loc3_.userData.type = "staticCar";
               if(!_loc4_)
               {
                  _loc3_.cbTypes.push(_-B-._-B8);
                  if(!(_loc4_ && (_loc2_)))
                  {
                     _loc2_++;
                  }
      ...
      public var fireLayer:MovieClip;
      
      override public function initPlayerCars() : void
      {
         var _loc5_:* = true;
         var _loc6_:* = false;
         var _loc1_:Vector.<Vec2> = null;
         var _loc2_:_-1A = null;
         var _loc3_:_-5a = null;
         if(_loc5_ || (_loc2_))
         {
            if(world.playerCarList.length > 0)
            {
               if(_loc5_)
               {
               }
            }
            _loc1_ = new Vector.<Vec2>();
            if(_loc5_ || (_loc3_))
            {
               _loc1_.push(new Vec2(-10,-17.5));
               if(_loc6_)
               {
               }
               _loc2_ = world.addCar(2560,2449,-180,0,_loc1_);
               if(_loc5_)
               {
                  world.playerCarList.push(_loc2_);
                  if(_loc5_)
                  {
                     _loc2_._-IB = 50;
                     if(_loc5_)
               ...
               if(!_loc6_)
               {
                  ...
                  if(!_loc6_)
                  {
                     ...
                     _loc2_ = world.addCar(2613,2460,-180,1,_loc1_);
                     if(!_loc6_)
                     {
                        world.playerCarList.push(_loc2_);
                        if(!_loc6_)
                     ...
                     if(!(_loc6_ && (_loc3_)))
                     {
                        ...
                        _loc1_.push(new Vec2(16,28));
                        _loc2_ = world.addCar(2670,2466,-180,2,_loc1_);
                        if(_loc5_ || (_loc3_))
                        {
                           world.playerCarList.push(_loc2_);
                           if(_loc6_)
                           ...
                           if(_loc5_)
                           {
                              _loc1_.push(new Vec2(-13,36));
                              if(_loc5_)
                              {
                              }
                              _loc3_ = new _-5a(new _-5a._-ER[0](),world.carLayer,_-9J._-64("6.95 -9.3 15.35 -9.3 15.35 60.5 -15.65 60.5 -15.65 -9.1 -6.85 -9.1 -6.85 -27.1 6.95 -27.1".split(" "),_-B-._-BD,_-B-._-6n),space,_loc1_);
                              if(!(_loc6_ && (_loc1_)))
                              {
                                 _loc3_.body.cbTypes.push(_-B-._-3q);
                              }
                              _loc2_ = world.addTrack(2578,2666,0,3,_loc3_);
                              if(!(_loc6_ && (_loc2_)))
                              {
                                 world.playerCarList.push(_loc2_);
                                 if(_loc5_)
                              ...
                              if(_loc5_ || (_loc3_))
                              {
                                 _loc1_.push(new Vec2(-13,55));
                                 if(_loc6_)
                                 {
                                 }
                                 _loc3_ = new _-5a(new _-5a._-ER[1](),world.carLayer,_-9J._-64("15.35 -10.75 15.35 81.55 -15.65 81.55 -15.65 -10.55 -6.85 -10.55 -6.85 -30.45 6.95 -30.45 6.95 -10.75".split(" "),_-B-._-BD,_-B-._-6n),space,_loc1_);
                                 if(_loc5_)
                                 {
                                    _loc3_.body.cbTypes.push(_-B-._-3q);
                                 }
                                 _loc2_ = world.addTrack(2650,2650,0,4,_loc3_);
                                 if(!_loc6_)
                                 {
                                    world.playerCarList.push(_loc2_);
                                    if(_loc6_)
         ...
         while(true)
         {
            if(_loc4_ >= 5)
            {
               if(!_loc6_)
               {
                  world.playerCarList = new Array();
                  break;
               }
               break;
               break;
            }
            world.playerCarList[_loc4_].disassemble();
            if(_loc5_ || (_loc1_))
            {
               _loc4_++;
               if(_loc5_)
      ...
      public var delta = 0.03333333333333333;
      ...
      override public function update() : void
      {
         ...
         if(!(_loc1_ && (_loc1_)))
         {
            this._-2f = this._-2f - this.delta;
            if(_loc2_)
            {
               if(this._-2f <= 0)
               {
         ...
         this._-LL = this._-LL - this.delta;
         if(this._-LL <= 0)
         {
            if(_loc2_)
            {
      ...
      private function _-Gb(param1:_-Bj, param2:Vector.<_-1A>) : Boolean
      {
         var _loc5_:* = false;
         var _loc3_:* = 0;
         while(_loc3_ < param2.length)
         {
            if(_-60._-9s(param1.x,param1.y,param2[_loc3_].x,param2[_loc3_].y) < 100)
            {
               if(!(_loc5_ && (param2)))
               {
                  if(!_loc5_)
      ...
      private function _-FS(param1:_-Bj, param2:Vector.<_-JC>) : Boolean
      {
         var _loc4_:* = false;
         var _loc5_:* = true;
         while(_loc3_ < param2.length)
         {
            if(_-60._-9s(param1.x,param1.y,param2[_loc3_].x,param2[_loc3_].y) < 40)
            {
               if(!_loc4_)
               {
                  if(_loc5_)
      ...
      private var _-Iq:Vector.<_-JC>;
      
      private var _-J0:Vector.<_-8f>;
      ...
      private function _-6d() : void
      {
         ...
         var _loc1_:Array = _-FM(_-4u["signLayer"]);
         for each(_loc2_ in _loc1_)
         {
            if(!_loc6_)
            {
               world.bottomLayer.addChild(_loc2_);
               if(_loc5_)
               {
               }
               this._-J0[this._-J0.length - 1].hide();
               continue;
            }
            this._-J0.push(new _-8f(_loc2_,_loc2_.x,_loc2_.y,300));
            if(!_loc6_)
            {
               this._-J0[this._-J0.length - 1].hide();
            }
      ...
      private function _-Eu() : void
      {
         var _loc3_:* = false;
         var _loc4_:* = true;
         var _loc1_:_-8f = null;
         var _loc2_:* = 0;
         while(_loc2_ < this._-J0.length)
         {
            _loc1_ = this._-J0[_loc2_];
            if(!(_loc3_ && (this)))
            {
               _loc1_._-Bl(world.playerCar.x,world.playerCar.y);
               if(!_loc3_)
               {
                  _loc2_++;
               }
      ...
      public function _-Ba(param1:Vector.<_-Bj>, param2:Rectangle) : Vector.<_-Bj>
      {
         var _loc6_:* = true;
         var _loc7_:* = false;
         var _loc4_:Vector.<_-Bj> = new Vector.<_-Bj>();
         var _loc5_:* = 0;
         while(_loc5_ < param1.length)
         {
            if(!_loc7_)
            {
               if(param2.contains(_loc3_.x,_loc3_.y))
               {
                  if(_loc6_ || (param1))
                  {
                     _loc4_.push(_loc3_);
      ...
      public function _-30(param1:Vector.<_-Bj>, param2:Rectangle) : Vector.<_-Bj>
      {
         var _loc7_:* = true;
      ...
      public function _-Bg(param1:_-JC, param2:Number = 0, param3:Number = 0, param4:Number = 0) : _-JC
      {
         var _loc5_:* = true;
         var _loc6_:* = false;
         if(!_loc6_)
         {
            param1._-3B(param2,param3);
            param1.body.rotation = _-60._-Ik(param4);
            world.updateList.push(param1);
            world.enemyList.push(param1);
            if(_loc5_)
            {
               world.middleLayer.addChild(param1.skin);
               if(_loc6_)
               {
               }
               return param1;
      ...
      public function _-4C(param1:int, param2:Number = 0, param3:Number = 0, param4:Number = 0) : _-JC
      {
         var _loc8_:* = false;
         var _loc5_:_-JC = null;
         if(!_loc8_)
         {
            if(_loc7_)
            {
