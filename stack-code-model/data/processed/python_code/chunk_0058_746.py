...
package com.neopets.marketing.trivia.popsicleTrivia
{
	...
	public class PopsicleTriviaEngine extends PopsicleTriviaEngineSupport
	{
		...
		public const TRIVIA_COMPLETED:String = "TriviaISDoneCloseMe";
		
		public const READY:String = "ShellisReady";
		public const TRANSITION_COMPLETE = "SceneTransitionIsDone";
		public const TRIVIA_LOADED:String = "TheConfigFileIsREady";
		...
		public function PopsicleTriviaEngine():void
		{
				...
				switch (pTransition)
				{
					...
					case TRANSITION_TOP_CENTER:
						...
						(
							...
							{
								ITEM:oldViewC,TIME:1,STARTLOC:new Point(0,0),ENDLOC:new Point(0,height + 100)
							}
					...
					case TRANSITION_BOT_CENTER:
						...
						(
							TransitionObject.MOVEMENT,
							{
								ITEM:newViewC,TIME:pTime,STARTLOC:new Point(0,height + 100),ENDLOC:new Point(0,0),
								FUNCTION:transitionComplete,PARAMTERS:[pCurrentScene,pNewScene]
							},
							
							{
								ITEM:oldViewC,TIME:1,STARTLOC:new Point(0,0),ENDLOC:new Point(0,-(height))
							}
					...
					case TRANSITION_RIGHT_CENTER:
						...
						(
							...
							{
								ITEM:oldViewC,TIME:1,STARTLOC:new Point(0,0),ENDLOC:new Point((oldViewC.x + width + 100),0)
							}
					...
					case TRANSITION_LEFT_CENTER:
						...
						(
							...
							{
								ITEM:oldViewC,TIME:1,STARTLOC:new Point(0,0),ENDLOC:new Point(-(width),0)
							}
		 ...
		 */
		 ...
		 protected function dispatchClose():void
		 {
		 	this.dispatchEvent(new Event(TRIVIA_COMPLETED));
		 }
		...
		*/
		...
		protected function completedSetup():void
		{
			...
			mGameShell_Events.dispatchEvent(new CustomEvent({CMD:mGameShell_Events.CMD_PRELOADER_DONE},mGameShell_Events.ACTION_SEND_CMD_SHELL));
		 	dispatchEvent(new Event(TRIVIA_LOADED));
		}
