...
package devoron.aswing3d.plaf.basic.border
{
	...
	public class ComboBoxPopupBorder implements Border, UIResource
	{
		...
		public function updateBorder(c:Component, g:Graphics2D, b:IntRectangle):void
		{
			...
			if (round < 0)
				round = 0;
			g.fillRoundRect(new GradientBrush(GradientBrush.LINEAR, [clTop.getRGB(), cl.getRGB()], [1, 1], [0, 100], matrix), b.x, b.y, b.width, b.height, round);
			shape.filter = BlurFilter.createDropShadow(1, 45, 0x0, 0.3, 4, 0.6);
		}
