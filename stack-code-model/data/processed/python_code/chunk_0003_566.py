class ZCB_BUG_WRKLOG_PERSIST definition
  public
...
public section.
*"* public components of class ZCB_BUG_WRKLOG_PERSIST
*"* do not include other source files here!!!
  ...
  methods CREATE_PERSISTENT
    importing
      ...
      !I_WRKLOG_ID type ZBT_ID_WRKLOG
    returning
      value(RESULT) type ref to ZCL_BUG_WRKLOG_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_BUG_WRKLOG_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_BUG_WRKLOG_PERSIST .
  types:
    begin of TYP_BUSINESS_KEY ,
      PRODUCTO type ZBT_ID_PRODUCTO ,
      BUG type ZBT_ID_BUG ,
      WRKLOG_ID type ZBT_ID_WRKLOG ,
  ...
  types:
    begin of TYP_DB_DATA ,
      ...
      BUG type ZBT_ID_BUG ,
      WRKLOG_ID type ZBT_ID_WRKLOG ,
      WRKLOG_CONCEPT type ZBT_WORKLOG_CONCEPT_ID ,
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_BUG_WRKLOG_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_BUG_WRKLOG_PERSIST IMPLEMENTATION.
...
*      IMPORTING I_WRKLOG_ID TYPE ZBT_ID_WRKLOG
*      RETURNING RESULT TYPE REF TO ZCL_BUG_WRKLOG_PERSIST
************************************************************************
...
*< Generated from mapping:
  ...
  BUSINESS_KEY-WRKLOG_ID = I_WRKLOG_ID.
*>
...
*<  Generated from mapping:
          ...
          THE_OBJECT->WRKLOG_ID = I_WRKLOG_ID.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_PRODUCTO = BUSINESS_KEY-PRODUCTO
                 I_BUG = BUSINESS_KEY-BUG
                 I_WRKLOG_ID = BUSINESS_KEY-WRKLOG_ID
...
*<Generated from mapping:
  ...
  E_BUSINESS_KEY-WRKLOG_ID  = I_DB_DATA-WRKLOG_ID.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_BUG_WRKLOG_PERSIST,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-WRKLOG_ID = THE_OBJECT->WRKLOG_ID.
    OBJECT_DATA_ITEM-WRKLOG_CONCEPT = THE_OBJECT->WRKLOG_CONCEPT.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_BUG_WRKLOG_PERSIST.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->PRODUCTO,
             THE_OBJECT->BUG,
             THE_OBJECT->WRKLOG_ID,
             THE_OBJECT->WRKLOG_CONCEPT,
             THE_OBJECT->USUARIO,
             THE_OBJECT->TEXTO,
             THE_OBJECT->ERDAT.
*>
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_BUG_WRKLOG.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_BUG_WRKLOG> type ZBT_BUG_WRKLOG.
*>

*< Generated from mapping:
  select * from ZBT_BUG_WRKLOG
           into table DB_DATA_LOCAL_TAB
           for all entries in I_BUSINESS_KEY_TAB
           where ZBT_BUG_WRKLOG~PRODUCTO = I_BUSINESS_KEY_TAB-PRODUCTO
             and ZBT_BUG_WRKLOG~BUG = I_BUSINESS_KEY_TAB-BUG
             and ZBT_BUG_WRKLOG~WRKLOG_ID =
             I_BUSINESS_KEY_TAB-WRKLOG_ID.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZBT_BUG_WRKLOG'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_BUG_WRKLOG>.

*< Generated from mapping:
    DB_DATA-PRODUCTO = <FS_DB_ZBT_BUG_WRKLOG>-PRODUCTO.
    DB_DATA-BUG = <FS_DB_ZBT_BUG_WRKLOG>-BUG.
    DB_DATA-WRKLOG_ID = <FS_DB_ZBT_BUG_WRKLOG>-WRKLOG_ID.
    DB_DATA-WRKLOG_CONCEPT = <FS_DB_ZBT_BUG_WRKLOG>-WRKLOG_CONCEPT.
    DB_DATA-USUARIO = <FS_DB_ZBT_BUG_WRKLOG>-USUARIO.
    DB_DATA-TEXTO = <FS_DB_ZBT_BUG_WRKLOG>-TEXTO.
    DB_DATA-ERDAT = <FS_DB_ZBT_BUG_WRKLOG>-ERDAT.
*>
...
*<  Generated from mapping:
    ...
    <FS_OBJECT_DATA>-WRKLOG_ID = BUSINESS_KEY-WRKLOG_ID.
*>
...
* * ZBT_BUG_WRKLOG: internal tables for mass operation
  data DB_ITB_ZBT_BUG_WRKLOG type STANDARD TABLE OF ZBT_BUG_WRKLOG.
  data DB_UTB_ZBT_BUG_WRKLOG type STANDARD TABLE OF ZBT_BUG_WRKLOG.
  data DB_DTB_ZBT_BUG_WRKLOG type STANDARD TABLE OF ZBT_BUG_WRKLOG.

* * ZBT_BUG_WRKLOG: headlines for tables
  data DB_ILN_ZBT_BUG_WRKLOG type ZBT_BUG_WRKLOG.
  data DB_ULN_ZBT_BUG_WRKLOG type ZBT_BUG_WRKLOG.
  data DB_DLN_ZBT_BUG_WRKLOG type ZBT_BUG_WRKLOG.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_BUG_WRKLOG-WRKLOG_CONCEPT = <FS_INSERT>-WRKLOG_CONCEPT.
   DB_ILN_ZBT_BUG_WRKLOG-USUARIO = <FS_INSERT>-USUARIO.
   DB_ILN_ZBT_BUG_WRKLOG-TEXTO = <FS_INSERT>-TEXTO.
   DB_ILN_ZBT_BUG_WRKLOG-ERDAT = <FS_INSERT>-ERDAT.


   DB_ILN_ZBT_BUG_WRKLOG-PRODUCTO = <FS_INSERT>-PRODUCTO.
   DB_ILN_ZBT_BUG_WRKLOG-BUG = <FS_INSERT>-BUG.
   DB_ILN_ZBT_BUG_WRKLOG-WRKLOG_ID = <FS_INSERT>-WRKLOG_ID.
   append DB_ILN_ZBT_BUG_WRKLOG to DB_ITB_ZBT_BUG_WRKLOG.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_BUG_WRKLOG-WRKLOG_CONCEPT = <FS_UPDATE>-WRKLOG_CONCEPT.
   DB_ULN_ZBT_BUG_WRKLOG-USUARIO = <FS_UPDATE>-USUARIO.
   DB_ULN_ZBT_BUG_WRKLOG-TEXTO = <FS_UPDATE>-TEXTO.
   DB_ULN_ZBT_BUG_WRKLOG-ERDAT = <FS_UPDATE>-ERDAT.


   DB_ULN_ZBT_BUG_WRKLOG-PRODUCTO = <FS_UPDATE>-PRODUCTO.
   DB_ULN_ZBT_BUG_WRKLOG-BUG = <FS_UPDATE>-BUG.
   DB_ULN_ZBT_BUG_WRKLOG-WRKLOG_ID = <FS_UPDATE>-WRKLOG_ID.
   append DB_ULN_ZBT_BUG_WRKLOG TO DB_UTB_ZBT_BUG_WRKLOG.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_BUG_WRKLOG-PRODUCTO = <FS_DELETE>-BUSINESS_KEY-PRODUCTO.
    DB_DLN_ZBT_BUG_WRKLOG-BUG = <FS_DELETE>-BUSINESS_KEY-BUG.
    DB_DLN_ZBT_BUG_WRKLOG-WRKLOG_ID =
    <FS_DELETE>-BUSINESS_KEY-WRKLOG_ID.

    append DB_DLN_ZBT_BUG_WRKLOG TO DB_DTB_ZBT_BUG_WRKLOG.
...
* * DB Deletes
  delete ZBT_BUG_WRKLOG FROM TABLE DB_DTB_ZBT_BUG_WRKLOG.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZBT_BUG_WRKLOG'.
  endif.

* * DB Inserts
  insert ZBT_BUG_WRKLOG FROM TABLE DB_ITB_ZBT_BUG_WRKLOG
...
* * DB Updates
  update ZBT_BUG_WRKLOG FROM TABLE DB_UTB_ZBT_BUG_WRKLOG.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  ...
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-WRKLOG_ID.
  concatenate RESULT COMP_STRING into RESULT.
*>
...
*<  Generated from mapping:
  ...
  THE_OBJECT->WRKLOG_ID = I_OBJECT_DATA-WRKLOG_ID.
  THE_OBJECT->WRKLOG_CONCEPT = I_OBJECT_DATA-WRKLOG_CONCEPT.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_BUG_WRKLOG_PERSIST.
...
* < Generated from mapping:
  ...
  NEW_OBJECT->WRKLOG_ID = I_BUSINESS_KEY-WRKLOG_ID.
* >
