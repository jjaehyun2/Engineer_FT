/*
	...
	Tool: Sniper (developed by Daniel Brendel)
	Version: 0.1
...
void CDG_API_DrawOnTop()
{
	...
	R_DrawSprite(g_hXHair, Vector(g_vCursorPos[0] - 400 - 10, g_vCursorPos[1] - 170 - 10), 0, 0.0, Vector(-1, -1), 0.0, 0.0, false, Color(0, 0, 0, 0));
}
...
bool CDG_API_QueryToolInfo(HostVersion hvVersion, ToolInfo &out info, const GameKeys& in gamekeys, const string &in szToolPath)
{
	...
	info.iCursorWidth = 195;
	info.iCursorHeight = 90;
