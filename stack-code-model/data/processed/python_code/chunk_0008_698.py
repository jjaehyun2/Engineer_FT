class ZCB_BUGSECCION_PERSIST definition
  public
  inheriting from CL_OS_CA_COMMON
  abstract
  create public .

*"* public components of class ZCB_BUGSECCION_PERSIST
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      ...
      !I_SECCION type ZBT_ID_SECCION
    returning
      value(RESULT) type ref to ZCL_BUGSECCION_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_BUGSECCION_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_BUGSECCION_PERSIST .
  types:
    begin of TYP_BUSINESS_KEY ,
      BUG type ZBT_ID_BUG ,
      PRODUCTO type ZBT_ID_PRODUCTO ,
      SECCION type ZBT_ID_SECCION ,
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_BUGSECCION_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_BUGSECCION_PERSIST IMPLEMENTATION.
...
*      IMPORTING I_SECCION TYPE ZBT_ID_SECCION
*      IMPORTING I_COMENTARIO TYPE ZBT_ID_COMENTARIO
*      RETURNING RESULT TYPE REF TO ZCL_BUGSECCION_PERSIST
************************************************************************
...
*< Generated from mapping:
  ...
  BUSINESS_KEY-SECCION = I_SECCION.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_BUG = BUSINESS_KEY-BUG
                 ...
                 I_SECCION = BUSINESS_KEY-SECCION
...
*<Generated from mapping:
  ...
  E_BUSINESS_KEY-SECCION  = I_DB_DATA-SECCION.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_BUGSECCION_PERSIST,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-SECCION = THE_OBJECT->SECCION.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUGSECCION'.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'SECCION'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUGSECCION'.
    MAP_ATT_INFO-FIELD_NAME1  = 'SECCION'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_BUGSECCION_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_BUGSECCION.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_BUGSECCION> type ZBT_BUGSECCION.
*>

*< Generated from mapping:
  select * from ZBT_BUGSECCION
           up to I_UPTO rows
...
*   * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZBT_BUGSECCION'
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_BUGSECCION>.

*< Generated from mapping:
    DB_DATA-BUG = <FS_DB_ZBT_BUGSECCION>-BUG.
    DB_DATA-COMENTARIO = <FS_DB_ZBT_BUGSECCION>-COMENTARIO.
    DB_DATA-PRODUCTO = <FS_DB_ZBT_BUGSECCION>-PRODUCTO.
    DB_DATA-SECCION = <FS_DB_ZBT_BUGSECCION>-SECCION.
*>
...
*< Generated from mapping:
  select * from ZBT_BUGSECCION
           ...
           where ZBT_BUGSECCION~BUG = I_BUSINESS_KEY_TAB-BUG
             and ZBT_BUGSECCION~PRODUCTO = I_BUSINESS_KEY_TAB-PRODUCTO
             and ZBT_BUGSECCION~SECCION = I_BUSINESS_KEY_TAB-SECCION.
*>
...
*<  Generated from mapping:
    ...
    <FS_OBJECT_DATA>-SECCION = BUSINESS_KEY-SECCION.
*>
...
* * ZBT_BUGSECCION: internal tables for mass operation
  data DB_ITB_ZBT_BUGSECCION type STANDARD TABLE OF ZBT_BUGSECCION.
  data DB_UTB_ZBT_BUGSECCION type STANDARD TABLE OF ZBT_BUGSECCION.
  data DB_DTB_ZBT_BUGSECCION type STANDARD TABLE OF ZBT_BUGSECCION.

* * ZBT_BUGSECCION: headlines for tables
  data DB_ILN_ZBT_BUGSECCION type ZBT_BUGSECCION.
  data DB_ULN_ZBT_BUGSECCION type ZBT_BUGSECCION.
  data DB_DLN_ZBT_BUGSECCION type ZBT_BUGSECCION.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_BUGSECCION-COMENTARIO = <FS_INSERT>-COMENTARIO.




   DB_ILN_ZBT_BUGSECCION-BUG = <FS_INSERT>-BUG.
   DB_ILN_ZBT_BUGSECCION-PRODUCTO = <FS_INSERT>-PRODUCTO.
   DB_ILN_ZBT_BUGSECCION-SECCION = <FS_INSERT>-SECCION.
   append DB_ILN_ZBT_BUGSECCION to DB_ITB_ZBT_BUGSECCION.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_BUGSECCION-COMENTARIO = <FS_UPDATE>-COMENTARIO.




   DB_ULN_ZBT_BUGSECCION-BUG = <FS_UPDATE>-BUG.
   DB_ULN_ZBT_BUGSECCION-PRODUCTO = <FS_UPDATE>-PRODUCTO.
   DB_ULN_ZBT_BUGSECCION-SECCION = <FS_UPDATE>-SECCION.
   append DB_ULN_ZBT_BUGSECCION TO DB_UTB_ZBT_BUGSECCION.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_BUGSECCION-BUG = <FS_DELETE>-BUSINESS_KEY-BUG.
    DB_DLN_ZBT_BUGSECCION-PRODUCTO = <FS_DELETE>-BUSINESS_KEY-PRODUCTO.
    DB_DLN_ZBT_BUGSECCION-SECCION = <FS_DELETE>-BUSINESS_KEY-SECCION.

    append DB_DLN_ZBT_BUGSECCION TO DB_DTB_ZBT_BUGSECCION.
...
* * DB Deletes
  delete ZBT_BUGSECCION FROM TABLE DB_DTB_ZBT_BUGSECCION.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZBT_BUGSECCION'.
  endif.

* * DB Inserts
  insert ZBT_BUGSECCION FROM TABLE DB_ITB_ZBT_BUGSECCION
...
* * DB Updates
  update ZBT_BUGSECCION FROM TABLE DB_UTB_ZBT_BUGSECCION.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  ...
  concatenate COMP_STRING TEMP_STRING into TEMP_STRING.
  COMP_STRING = I_BUSINESS_KEY-SECCION.
  concatenate COMP_STRING TEMP_STRING into TEMP_STRING.
*>
...
*<  Generated from mapping:
  ...
  THE_OBJECT->SECCION = I_OBJECT_DATA-SECCION.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_BUGSECCION_PERSIST.
...
* < Generated from mapping:
  ...
  NEW_OBJECT->SECCION = I_BUSINESS_KEY-SECCION.
* >
