...
class templateSlider.mvcgallery.TimeView extends AbstractView {
...
function onLoad(){
	...
	if(Configuration.COLOR_TIME_CIRCLE.length){
	NewColor.setColor(spiral, Configuration.COLOR_TIME_CIRCLE.split(",")[0])
	spiral._alpha = Configuration.COLOR_TIME_CIRCLE.split(",")[1]
	}
}
