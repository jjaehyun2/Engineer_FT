...
package starling.display
{
	...
	public class DisplayObject extends EventDispatcher
	{
		...
		private var _orientation3DChanged : Boolean;
...
//			}
		...
		public function get transformationMatrix() : Matrix
		{
			if ( _orientationChanged )
			{
				...
				// optimization: no  rotation simplifies the matrix math
				if ( _rotation == 0.0 )
				{
...
//			return MatrixUtil.convertTo3D(transformationMatrix, _transformationMatrix3D);
			if ( _orientation3DChanged )
			{
				_orientation3DChanged = false;

				var sRawData : Vector.<Number> = MatrixUtil.sRawData;
				var matrix : Matrix = transformationMatrix;
				sRawData[ 0 ] = matrix.a;
				sRawData[ 1 ] = matrix.b;
				sRawData[ 4 ] = matrix.c;
				sRawData[ 5 ] = matrix.d;
				...
				_transformationMatrix3D.copyRawDataFrom( sRawData );
			}
		...
		public function set useHandCursor( value : Boolean ) : void
		{
			...
			if ( _useHandCursor && Starling.supportEditCursor )
