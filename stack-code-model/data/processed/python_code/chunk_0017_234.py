class ZCL_HTTP_STATUS_CODES definition
  public
...
protected section.
*"* protected components of class zCL_HTTP_STATUS_CODES
*"* do not include other source files here!!!
private section.
*"* private components of class zCL_HTTP_STATUS_CODES
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_HTTP_STATUS_CODES IMPLEMENTATION.
ENDCLASS.