...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class caurina.transitions.TweenListObj
    {
        ...
        function TweenListObj (_arg2, _arg5, _arg4, _arg6, _arg3, _arg7) {
            scope = _arg2;
            timeStart = _arg5;
            timeComplete = _arg4;
            useFrames = _arg6;
            transition = _arg3;
            transitionParams = _arg7;
        ...
        static function makePropertiesChain(_arg8) {
            var _local6 = _arg8.base;
            if (_local6) {
                var _local5 = {};
                var _local2;
