...
[ExcludeClass]
public class _Checkout_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _Checkout_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "Checkout" : String(params[0]);
...
,
            ...
            compiledResourceBundleNames: [ "SharedResources", "collections", "components", "controls", "core", "effects", "layout", "skins", "styles", "textLayout" ],
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "Checkout",
            minHeight: "600",
            minWidth: "955",
            mixins: [ "_Checkout_FlexInit", "_Checkout_Styles", "mx.managers.systemClasses.ActiveWindowManager" ],
            placeholderRsls: [
