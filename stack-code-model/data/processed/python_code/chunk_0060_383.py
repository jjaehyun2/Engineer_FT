...
package com.neopets.projects.neopetsGameShell.document
{
	...
	import com.neopets.projects.neopetsGameShell.support.NeopetsInterfaceSupport;
	...
	public class GameShell_Interface extends NeopetsInterfaceSupport
	{
		...
		private function setupDisplayElements(pSceneName:String):void
		{
			...
			switch (pSceneName)
			{
				case SCENE_GAME_INTRO:
					...
					tButtonArray = 
					[
					{ID:"startBtn",LOCATION:new Point(330,200),DISPLAYORDER:1,DISPLAY:true,TEXT:'Start Game'},
					{ID:"helpBtn",LOCATION:new Point(330,250),DISPLAYORDER:2,DISPLAY:true,TEXT:'Instructions'},
					{ID:"aboutBtn",LOCATION:new Point(330,300),DISPLAYORDER:3,DISPLAY:true,TEXT:'About'},
					{ID:"trailerBtn",LOCATION:new Point(330,350),DISPLAYORDER:4,DISPLAY:true,TEXT:'Trailer'},
					{ID:"webBtn",LOCATION:new Point(330,400),DISPLAYORDER:5,DISPLAY:true,TEXT:'View Website'}
					];
				...
				case SCENE_GAME_ENDSCREEN:
					...
					tButtonArray = 
					[
						{ID:"sendScoreBtn",LOCATION:new Point(330,375),DISPLAYORDER:1,DISPLAY:true,TEXT:'Send Score'},
						{ID:"returnBtn",LOCATION:new Point(330,425),DISPLAYORDER:2,DISPLAY:true,TEXT:'Back to Menu'}
					];	
				...
				case SCENE_GAME_INSTRUCTION:
					...
					tButtonArray = 
					[
						{ID:"returnBtn",LOCATION:new Point(330,225),DISPLAYORDER:1,DISPLAY:true,TEXT:'Back to Menu'}	
					];
				...
				case SCENE_GAME_TRAILER:
					...
					tButtonArray = 
					[
						{ID:"highBWBtn",LOCATION:new Point(200,155),DISPLAYORDER:1,DISPLAY:true,TEXT:'High Bandwidth'},
						{ID:"lowBWBtn",LOCATION:new Point(200,200),DISPLAYORDER:1,DISPLAY:true,TEXT:'Low Bandwidth'},
						{ID:"returnBtn",LOCATION:new Point(330,425),DISPLAYORDER:1,DISPLAY:true,TEXT:'Back to Menu'}	
					];
		...
		private function onButtonAction(evt:CustomEvent):void
		{
			if (!mButtonLock)
			{
				/* Generic Sound for all Button Clicks */
				mSM_Interface.soundPlay("ClickButton");	
				...
				switch(evt.oData.SCENEID)
				{
					case mIntroScene.ID:
						switch (evt.oData.BUTTON)
						{
							...
							break;
							case "helpBtn":
								mSM_Interface.soundPlay("GameStart");
