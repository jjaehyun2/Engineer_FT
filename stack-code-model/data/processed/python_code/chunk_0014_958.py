class ZCL_BUGCOMMENT_PERSIST definition
  public
  final
  create protected

  global friends ZCB_BUGCOMMENT_PERSIST .

*"* public components of class ZCL_BUGCOMMENT_PERSIST
...
protected section.
*"* protected components of class ZCL_BUGCOMMENT_PERSIST
*"* do not include other source files here!!!
...
private section.
*"* private components of class ZCL_BUGCOMMENT_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_BUGCOMMENT_PERSIST IMPLEMENTATION.
