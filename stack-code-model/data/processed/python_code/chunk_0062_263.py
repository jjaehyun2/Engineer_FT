		...
		public static function setscale(t:int):void
		{
			...
			case CHORD_SUS2: 
		       ...
		       case SCALE_NATURAL_MINOR: 
			     ...
			     break;
		      case SCALE_DORIAN: 
		           _setscale(2, 1, 2, 2, 2, 1, 2); 
			   break;
		      case SCALE_PHRYGIAN: 
		           _setscale(1, 2, 2, 2, 1, 2, 2); 
			   break;
		      case SCALE_LYDIAN: 
		          _setscale(2, 2, 2, 1, 2, 2, 1); 
		           break;
		      case SCALE_LOCRIAN: 
		          _setscale(1, 2, 2, 1, 2, 2, 2); 
			    break;
		      case SCALE_DOMINANT: 
		         _setscale(2, 2, 1, 2, 2, 1, 2); 
		           break;
		      case SCALE_ALTERED_DOM:
		          _setscale(1, 2, 1, 2, 2, 2, 2); 
			     break;
		     case SCALE_SYMMETRIC_HW: 
		         _setscale(1, 2, 1, 2, 1, 2, 1, 2); 
			 break;
		     case SCALE_SYMMETRIC_WH: 
		        _setscale(2, 1, 2, 1, 2, 1, 2, 1); 
			    break;
		     case SCALE_WHOLE_TONE: 
		         _setscale(2, 2, 2, 2, 2, 2); 
			    break;
		     case SCALE_MELODIC_MINOR: 
		         _setscale(2, 1, 2, 2, 2, 2, 1); 
			    break;
		  case SCALE_MELODIC_MAJOR: 
		     _setscale(2, 2, 1, 2, 1, 2, 2); 
		         break;
			default: 
			case SCALE_NORMAL: 
