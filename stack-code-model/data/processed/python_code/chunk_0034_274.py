package org.red5.server.io
{
   ...
   */
  public class EchoObjectTest extends YardTestCase
  {
      ...
      private const testObj:CustomObject = new CustomObject();
      ...
      public function EchoObjectTest(name:String=null)
      {
        super(name);
      ...
      public function testEchoObjectAmf0():void
      {
        // set encoding 
      ...
      public function startEchoObjectTest():void
      {
      ...
      public function onCallbackSuccess_EchoObject(obj:Object):void
      {
        ...
        var customObj:CustomObject = new CustomObject(obj);

        assertTrue("numbers should match",
          testObj.mNumber  == customObj.mNumber);
        assertTrue("strings should match",
          testObj.mString == customObj.mString);
        assertTrue("but should be a different instance",
          customObj != testObj);
