...
package com.neopets.games.inhouse.AdventureFactory.editor.options
{
	...
	/**
	 *	This class links an image-based tab to the hero character.
	 * 
	...
	public class HeroButton extends ImageTab
	{
		...
		public function HeroButton():void{
			super();
			selectionEvent = LevelPane.CHANGE_HERO;
		}
		...
		override public function set imageID(id:String) {
			...
			if(_defaultDispatcher != null) {
				...
				if(screen != null) {
					...
					if(world != null) selected = (world.heroClass == selectionData);
				}
			}
		}
