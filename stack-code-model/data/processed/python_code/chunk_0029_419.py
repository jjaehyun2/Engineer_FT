...
package org.aswing.components.menus
{
	...
	public class JPopupMenu extends Container implements MenuElement
	{
		...
		{
			var ui:ComponentUI = UIManager.getUI(this);
			setUI(ui);
			popup.setBackgroundDecorator(new ColorDecorator(new ASColor(0xFF0000, 0)));
			setBackgroundDecorator(new ColorDecorator(new ASColor(0XFFFFFF, 0.14)));
