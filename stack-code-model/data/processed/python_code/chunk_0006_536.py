class ZCL_ZGW_OPENAPI_TEST_MPC definition
  public
...
CLASS ZCL_ZGW_OPENAPI_TEST_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_OPENAPI_TEST_SRV' ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Idadtype' iv_abap_fieldname = 'IDADTYPE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20190819185019'.                  "#EC NOTEXT
