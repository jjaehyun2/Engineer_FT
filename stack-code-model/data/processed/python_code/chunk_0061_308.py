package game.global {
	 ...
	 */
	public class Make {
		public static function buttonColor(onClick:Function, text:String, txtColor:uint = 0xFFFFFF, bg:uint = 0x000000, outline:uint = 0xFFFFFF, width:Number = NaN):RetrocamelButton {
