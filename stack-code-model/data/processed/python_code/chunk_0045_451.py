package qihoo.triplecleangame.protos {
	...
	public dynamic final class CMsgRecommendFriendResponse extends com.netease.protobuf.Message {
		public static const USERQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgRecommendFriendResponse.userQID", "userQID", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const FRIENDLIST:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("qihoo.triplecleangame.protos.CMsgRecommendFriendResponse.friendList", "friendList", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, qihoo.triplecleangame.protos.PBFriendList);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (userQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgRecommendFriendResponse.userQID cannot be set twice.');
					}
					++userQID$count;
