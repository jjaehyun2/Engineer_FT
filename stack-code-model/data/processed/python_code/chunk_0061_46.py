...
package org.igniterealtime.xiff.collections
{
	...
	{
		[Test( description="array with single value" )]
		public function testSingleValueArray():void
		{
			var testValue:Array = [44];
			var collection:ArrayCollection = new ArrayCollection( testValue );
			assertEquals( testValue.toString(), collection.source.toString() );
		}
