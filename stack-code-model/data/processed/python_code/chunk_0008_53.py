CLASS /xxx/cl_abapgit_object_clas DEFINITION PUBLIC INHERITING FROM /xxx/cl_abapgit_object_clas_old.

  PUBLIC SECTION.
    METHODS: constructor
      IMPORTING
        is_item     TYPE /xxx/if_abapgit_definitions=>ty_item
...
CLASS /xxx/cl_abapgit_object_clas IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    CREATE OBJECT mo_object_oriented_object_fct TYPE /xxx/cl_abapgit_oo_class_new.
    
  ENDMETHOD.

  METHOD deserialize_abap.
* same as in /xxx/cl_abapgit_object_clas, but without "mo_object_oriented_object_fct->add_to_activation_list"
    ...
    DATA: ls_vseoclass             TYPE vseoclass,
          ...
          lt_descriptions          TYPE /xxx/if_abapgit_definitions=>ty_seocompotx_tt,
