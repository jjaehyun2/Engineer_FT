...
package org.igniterealtime.xiff.data.forms
{
	...
	public class FormItemTest
	{
		...
		/*
		[Test( description="fields value" )]
		public function testValueFields():void
		{
			var testValue:Array = [];

			var ext:FormItem = new FormItem();
			ext.fields = testValue;

			assertEquals( testValue, ext.fields );
		}
		*/
		...
		[Test( description="parse from XML - fields length" )]
		public function testParseFieldsLength():void
		{
			...
			assertEquals( testValue, ext.fields.length );
		}
