class ZCB_BUGCOMMENT_PERSIST definition
  public
  inheriting from CL_OS_CA_COMMON
  abstract
  create public .

*"* public components of class ZCB_BUGCOMMENT_PERSIST
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      ...
      !I_ERDAT type ZBT_ERDAT optional
      !I_PRODUCTO type ZBT_ID_PRODUCTO
      !I_TEXTO type ZBT_TEXTO_LARGO optional
      !I_USUARIO type XUBNAME optional
    returning
      value(RESULT) type ref to ZCL_BUGCOMMENT_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_BUGCOMMENT_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_BUGCOMMENT_PERSIST .
  types:
    begin of TYP_BUSINESS_KEY ,
      BUG type ZBT_ID_BUG ,
      COMENTARIO type ZBT_ID_COMENTARIO ,
  ...
  types:
    begin of TYP_DB_DATA ,
      BUG type ZBT_ID_BUG ,
      COMENTARIO type ZBT_ID_COMENTARIO ,
      ERDAT type ZBT_ERDAT ,
      PRODUCTO type ZBT_ID_PRODUCTO ,
      TEXTO type ZBT_TEXTO_LARGO ,
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_BUGCOMMENT_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_BUGCOMMENT_PERSIST IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 051402
*      IMPORTING I_BUG TYPE ZBT_ID_BUG
*      IMPORTING I_COMENTARIO TYPE ZBT_ID_COMENTARIO
*      IMPORTING I_PRODUCTO TYPE ZBT_ID_PRODUCTO
*      IMPORTING I_ERDAT TYPE ZBT_ERDAT
*      IMPORTING I_TEXTO TYPE ZBT_TEXTO_LARGO
*      IMPORTING I_USUARIO TYPE XUBNAME
*      RETURNING RESULT TYPE REF TO ZCL_BUGCOMMENT_PERSIST
************************************************************************
...
*< Generated from mapping:
  ...
  BUSINESS_KEY-COMENTARIO = I_COMENTARIO.
...
*<  Generated from mapping:
          ...
          THE_OBJECT->COMENTARIO = I_COMENTARIO.
          THE_OBJECT->PRODUCTO = I_PRODUCTO.
          THE_OBJECT->ERDAT = I_ERDAT.
          THE_OBJECT->TEXTO = I_TEXTO.
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_BUG = BUSINESS_KEY-BUG
                 I_COMENTARIO = BUSINESS_KEY-COMENTARIO
...
*<Generated from mapping:
  ...
  E_BUSINESS_KEY-COMENTARIO  = I_DB_DATA-COMENTARIO.
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-COMENTARIO = THE_OBJECT->COMENTARIO.
    OBJECT_DATA_ITEM-ERDAT = THE_OBJECT->ERDAT.
    OBJECT_DATA_ITEM-PRODUCTO = THE_OBJECT->PRODUCTO.
    OBJECT_DATA_ITEM-TEXTO = THE_OBJECT->TEXTO.
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUGCOMMENT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'BUG'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'COMENTARIO'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUGCOMMENT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'COMENTARIO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ERDAT'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUGCOMMENT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ERDAT'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'TEXTO'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUGCOMMENT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'TEXTO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_BUGCOMMENT_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_BUGCOMMENT.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_BUGCOMMENT> type ZBT_BUGCOMMENT.
*>

*< Generated from mapping:
  select * from ZBT_BUGCOMMENT
           up to I_UPTO rows
...
*   * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZBT_BUGCOMMENT'
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_BUGCOMMENT>.

*< Generated from mapping:
    DB_DATA-BUG = <FS_DB_ZBT_BUGCOMMENT>-BUG.
    DB_DATA-COMENTARIO = <FS_DB_ZBT_BUGCOMMENT>-COMENTARIO.
    DB_DATA-ERDAT = <FS_DB_ZBT_BUGCOMMENT>-ERDAT.
    DB_DATA-PRODUCTO = <FS_DB_ZBT_BUGCOMMENT>-PRODUCTO.
    DB_DATA-TEXTO = <FS_DB_ZBT_BUGCOMMENT>-TEXTO.
    DB_DATA-USUARIO = <FS_DB_ZBT_BUGCOMMENT>-USUARIO.
*>
...
*< Generated from mapping:
  select * from ZBT_BUGCOMMENT
           ...
           where ZBT_BUGCOMMENT~BUG = I_BUSINESS_KEY_TAB-BUG
             and ZBT_BUGCOMMENT~COMENTARIO =
             I_BUSINESS_KEY_TAB-COMENTARIO
             and ZBT_BUGCOMMENT~PRODUCTO = I_BUSINESS_KEY_TAB-PRODUCTO.
*>
...
*<  Generated from mapping:
    ...
    <FS_OBJECT_DATA>-COMENTARIO = BUSINESS_KEY-COMENTARIO.
...
* * ZBT_BUGCOMMENT: internal tables for mass operation
  data DB_ITB_ZBT_BUGCOMMENT type STANDARD TABLE OF ZBT_BUGCOMMENT.
  data DB_UTB_ZBT_BUGCOMMENT type STANDARD TABLE OF ZBT_BUGCOMMENT.
  data DB_DTB_ZBT_BUGCOMMENT type STANDARD TABLE OF ZBT_BUGCOMMENT.

* * ZBT_BUGCOMMENT: headlines for tables
  data DB_ILN_ZBT_BUGCOMMENT type ZBT_BUGCOMMENT.
  data DB_ULN_ZBT_BUGCOMMENT type ZBT_BUGCOMMENT.
  data DB_DLN_ZBT_BUGCOMMENT type ZBT_BUGCOMMENT.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_BUGCOMMENT-ERDAT = <FS_INSERT>-ERDAT.

   DB_ILN_ZBT_BUGCOMMENT-TEXTO = <FS_INSERT>-TEXTO.
   DB_ILN_ZBT_BUGCOMMENT-USUARIO = <FS_INSERT>-USUARIO.


   DB_ILN_ZBT_BUGCOMMENT-BUG = <FS_INSERT>-BUG.
   DB_ILN_ZBT_BUGCOMMENT-COMENTARIO = <FS_INSERT>-COMENTARIO.
   DB_ILN_ZBT_BUGCOMMENT-PRODUCTO = <FS_INSERT>-PRODUCTO.
   append DB_ILN_ZBT_BUGCOMMENT to DB_ITB_ZBT_BUGCOMMENT.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_BUGCOMMENT-ERDAT = <FS_UPDATE>-ERDAT.

   DB_ULN_ZBT_BUGCOMMENT-TEXTO = <FS_UPDATE>-TEXTO.
   DB_ULN_ZBT_BUGCOMMENT-USUARIO = <FS_UPDATE>-USUARIO.


   DB_ULN_ZBT_BUGCOMMENT-BUG = <FS_UPDATE>-BUG.
   DB_ULN_ZBT_BUGCOMMENT-COMENTARIO = <FS_UPDATE>-COMENTARIO.
   DB_ULN_ZBT_BUGCOMMENT-PRODUCTO = <FS_UPDATE>-PRODUCTO.
   append DB_ULN_ZBT_BUGCOMMENT TO DB_UTB_ZBT_BUGCOMMENT.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_BUGCOMMENT-BUG = <FS_DELETE>-BUSINESS_KEY-BUG.
    DB_DLN_ZBT_BUGCOMMENT-COMENTARIO =
    <FS_DELETE>-BUSINESS_KEY-COMENTARIO.
    DB_DLN_ZBT_BUGCOMMENT-PRODUCTO = <FS_DELETE>-BUSINESS_KEY-PRODUCTO.

    append DB_DLN_ZBT_BUGCOMMENT TO DB_DTB_ZBT_BUGCOMMENT.
...
* * DB Deletes
  delete ZBT_BUGCOMMENT FROM TABLE DB_DTB_ZBT_BUGCOMMENT.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZBT_BUGCOMMENT'.
  endif.

* * DB Inserts
  insert ZBT_BUGCOMMENT FROM TABLE DB_ITB_ZBT_BUGCOMMENT
...
* * DB Updates
  update ZBT_BUGCOMMENT FROM TABLE DB_UTB_ZBT_BUGCOMMENT.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  ...
  COMP_STRING = I_BUSINESS_KEY-COMENTARIO.
  concatenate COMP_STRING TEMP_STRING into TEMP_STRING.
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_BUGCOMMENT_PERSIST,
        AN_OBJECT  type ref to OBJECT, "#EC *
        PM_SERVICE type ref to IF_OS_PM_SERVICE. "#EC NEEDED
...
*<  Generated from mapping:
  ...
  THE_OBJECT->COMENTARIO = I_OBJECT_DATA-COMENTARIO.
  THE_OBJECT->ERDAT = I_OBJECT_DATA-ERDAT.
  THE_OBJECT->PRODUCTO = I_OBJECT_DATA-PRODUCTO.
  THE_OBJECT->TEXTO = I_OBJECT_DATA-TEXTO.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_BUGCOMMENT_PERSIST.
...
* < Generated from mapping:
  ...
  NEW_OBJECT->COMENTARIO = I_BUSINESS_KEY-COMENTARIO.
