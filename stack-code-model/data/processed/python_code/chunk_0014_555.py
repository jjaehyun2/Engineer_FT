class ZCB_ATTACHEMENT_PERSIST definition
  public
  inheriting from CL_OS_CA_COMMON
  abstract
  create public .

*"* public components of class ZCB_ATTACHEMENT_PERSIST
*"* do not include other source files here!!!
public section.

  methods CREATE_PERSISTENT
    importing
      !I_ATTATCHMENT type ZBT_ATTATCHMENT
      !I_BUG type ZBT_ID_BUG
      !I_COMENTARIO type ZBT_ID_COMENTARIO optional
      !I_NAME type VTEXT optional
      !I_PRODUCTO type ZBT_ID_PRODUCTO
    returning
      value(RESULT) type ref to ZCL_ATTACHEMENT_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_ATTACHEMENT_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_ATTACHEMENT_PERSIST .
  types:
    begin of TYP_BUSINESS_KEY ,
      ATTATCHMENT type ZBT_ATTATCHMENT ,
      BUG type ZBT_ID_BUG ,
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_ATTACHEMENT_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_ATTACHEMENT_PERSIST IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 051402
*      IMPORTING I_ATTATCHMENT TYPE ZBT_ATTATCHMENT
*      IMPORTING I_BUG TYPE ZBT_ID_BUG
*      IMPORTING I_PRODUCTO TYPE ZBT_ID_PRODUCTO
*      IMPORTING I_COMENTARIO TYPE ZBT_ID_COMENTARIO
*      IMPORTING I_NAME TYPE VTEXT
*      RETURNING RESULT TYPE REF TO ZCL_ATTACHEMENT_PERSIST
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-ATTATCHMENT = I_ATTATCHMENT.
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_ATTATCHMENT = BUSINESS_KEY-ATTATCHMENT
...
*<Generated from mapping:
  E_BUSINESS_KEY-ATTATCHMENT  = I_DB_DATA-ATTATCHMENT.
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_ATTACHEMENT_PERSIST,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-ATTATCHMENT = THE_OBJECT->ATTATCHMENT.
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ATTATCHMENT'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_ATTACHMENT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ATTATCHMENT'.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'NAME'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_ATTACHMENT'.
    MAP_ATT_INFO-FIELD_NAME1  = 'NAME'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_ATTACHEMENT_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_ATTACHMENT.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_ATTACHMENT> type ZBT_ATTACHMENT.
*>

*< Generated from mapping:
  select * from ZBT_ATTACHMENT
           up to I_UPTO rows
...
*   * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZBT_ATTACHMENT'
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_ATTACHMENT>.

*< Generated from mapping:
    DB_DATA-ATTATCHMENT = <FS_DB_ZBT_ATTACHMENT>-ATTATCHMENT.
    DB_DATA-BUG = <FS_DB_ZBT_ATTACHMENT>-BUG.
    DB_DATA-COMENTARIO = <FS_DB_ZBT_ATTACHMENT>-COMENTARIO.
    DB_DATA-NAME = <FS_DB_ZBT_ATTACHMENT>-NAME.
    DB_DATA-PRODUCTO = <FS_DB_ZBT_ATTACHMENT>-PRODUCTO.
*>
...
*< Generated from mapping:
  select * from ZBT_ATTACHMENT
           ...
           where ZBT_ATTACHMENT~ATTATCHMENT =
           I_BUSINESS_KEY_TAB-ATTATCHMENT
             and ZBT_ATTACHMENT~BUG = I_BUSINESS_KEY_TAB-BUG
             and ZBT_ATTACHMENT~PRODUCTO = I_BUSINESS_KEY_TAB-PRODUCTO.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-ATTATCHMENT = BUSINESS_KEY-ATTATCHMENT.
...
* * ZBT_ATTACHMENT: internal tables for mass operation
  data DB_ITB_ZBT_ATTACHMENT type STANDARD TABLE OF ZBT_ATTACHMENT.
  data DB_UTB_ZBT_ATTACHMENT type STANDARD TABLE OF ZBT_ATTACHMENT.
  data DB_DTB_ZBT_ATTACHMENT type STANDARD TABLE OF ZBT_ATTACHMENT.

* * ZBT_ATTACHMENT: headlines for tables
  data DB_ILN_ZBT_ATTACHMENT type ZBT_ATTACHMENT.
  data DB_ULN_ZBT_ATTACHMENT type ZBT_ATTACHMENT.
  data DB_DLN_ZBT_ATTACHMENT type ZBT_ATTACHMENT.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_ATTACHMENT-COMENTARIO = <FS_INSERT>-COMENTARIO.
   DB_ILN_ZBT_ATTACHMENT-NAME = <FS_INSERT>-NAME.



   DB_ILN_ZBT_ATTACHMENT-ATTATCHMENT = <FS_INSERT>-ATTATCHMENT.
   DB_ILN_ZBT_ATTACHMENT-BUG = <FS_INSERT>-BUG.
   DB_ILN_ZBT_ATTACHMENT-PRODUCTO = <FS_INSERT>-PRODUCTO.
   append DB_ILN_ZBT_ATTACHMENT to DB_ITB_ZBT_ATTACHMENT.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_ATTACHMENT-COMENTARIO = <FS_UPDATE>-COMENTARIO.
   DB_ULN_ZBT_ATTACHMENT-NAME = <FS_UPDATE>-NAME.



   DB_ULN_ZBT_ATTACHMENT-ATTATCHMENT = <FS_UPDATE>-ATTATCHMENT.
   DB_ULN_ZBT_ATTACHMENT-BUG = <FS_UPDATE>-BUG.
   DB_ULN_ZBT_ATTACHMENT-PRODUCTO = <FS_UPDATE>-PRODUCTO.
   append DB_ULN_ZBT_ATTACHMENT TO DB_UTB_ZBT_ATTACHMENT.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_ATTACHMENT-ATTATCHMENT =
    <FS_DELETE>-BUSINESS_KEY-ATTATCHMENT.
    DB_DLN_ZBT_ATTACHMENT-BUG = <FS_DELETE>-BUSINESS_KEY-BUG.
    DB_DLN_ZBT_ATTACHMENT-PRODUCTO = <FS_DELETE>-BUSINESS_KEY-PRODUCTO.

    append DB_DLN_ZBT_ATTACHMENT TO DB_DTB_ZBT_ATTACHMENT.
...
* * DB Deletes
  delete ZBT_ATTACHMENT FROM TABLE DB_DTB_ZBT_ATTACHMENT.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZBT_ATTACHMENT'.
  endif.

* * DB Inserts
  insert ZBT_ATTACHMENT FROM TABLE DB_ITB_ZBT_ATTACHMENT
...
* * DB Updates
  update ZBT_ATTACHMENT FROM TABLE DB_UTB_ZBT_ATTACHMENT.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-ATTATCHMENT.
...
*<  Generated from mapping:
  THE_OBJECT->ATTATCHMENT = I_OBJECT_DATA-ATTATCHMENT.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_ATTACHEMENT_PERSIST.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->ATTATCHMENT = I_BUSINESS_KEY-ATTATCHMENT.
