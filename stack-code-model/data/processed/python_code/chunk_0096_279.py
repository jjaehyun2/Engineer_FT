package qihoo.triplecleangame.protos {
	...
	public dynamic final class CMsgPlayerAcceptInviteResponse extends com.netease.protobuf.Message {
		public static const USERQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgPlayerAcceptInviteResponse.userQID", "userQID", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const FRIENDQID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("qihoo.triplecleangame.protos.CMsgPlayerAcceptInviteResponse.friendQID", "friendQID", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const RESULT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgPlayerAcceptInviteResponse.result", "result", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (userQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgPlayerAcceptInviteResponse.userQID cannot be set twice.');
					}
					++userQID$count;
				...
				case 2:
					if (friendQID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgPlayerAcceptInviteResponse.friendQID cannot be set twice.');
					}
					++friendQID$count;
				...
				case 3:
					if (result$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgPlayerAcceptInviteResponse.result cannot be set twice.');
					}
					++result$count;
