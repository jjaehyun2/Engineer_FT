class ZCB_COMPONENTE_PERSIST definition
  public
  inheriting from CL_OS_CA_COMMON
  abstract
  create public .

*"* public components of class ZCB_COMPONENTE_PERSIST
...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_COMPONENTE_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_COMPONENTE_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_COMPONENTE_PERSIST .
  types:
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_COMPONENTE_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_COMPONENTE_PERSIST IMPLEMENTATION.
...
*      RETURNING RESULT TYPE REF TO ZCL_COMPONENTE_PERSIST
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-COMPONENTE = I_COMPONENTE.
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_COMPONENTE = BUSINESS_KEY-COMPONENTE
...
*<Generated from mapping:
  E_BUSINESS_KEY-COMPONENTE  = I_DB_DATA-COMPONENTE.
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_COMPONENTE_PERSIST,
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZBT_COMPONT'.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_COMPONENTE_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_COMPONT.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_COMPONT> type ZBT_COMPONT.
*>

*< Generated from mapping:
  select * from ZBT_COMPONT
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_COMPONT>.

*< Generated from mapping:
    DB_DATA-COMPONENTE = <FS_DB_ZBT_COMPONT>-COMPONENTE.
    DB_DATA-PRODUCTO = <FS_DB_ZBT_COMPONT>-PRODUCTO.
*>
...
*< Generated from mapping:
  select * from ZBT_COMPONT
           ...
           where ZBT_COMPONT~COMPONENTE = I_BUSINESS_KEY_TAB-COMPONENTE
             and ZBT_COMPONT~PRODUCTO = I_BUSINESS_KEY_TAB-PRODUCTO.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-COMPONENTE = BUSINESS_KEY-COMPONENTE.
...
* * ZBT_COMPONT: internal tables for mass operation
  data DB_ITB_ZBT_COMPONT type STANDARD TABLE OF ZBT_COMPONT.
  data DB_UTB_ZBT_COMPONT type STANDARD TABLE OF ZBT_COMPONT.
  data DB_DTB_ZBT_COMPONT type STANDARD TABLE OF ZBT_COMPONT.

* * ZBT_COMPONT: headlines for tables
  data DB_ILN_ZBT_COMPONT type ZBT_COMPONT.
  data DB_ULN_ZBT_COMPONT type ZBT_COMPONT.
  data DB_DLN_ZBT_COMPONT type ZBT_COMPONT.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_COMPONT-COMPONENTE = <FS_INSERT>-COMPONENTE.
   DB_ILN_ZBT_COMPONT-PRODUCTO = <FS_INSERT>-PRODUCTO.
   append DB_ILN_ZBT_COMPONT to DB_ITB_ZBT_COMPONT.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_COMPONT-COMPONENTE = <FS_UPDATE>-COMPONENTE.
   DB_ULN_ZBT_COMPONT-PRODUCTO = <FS_UPDATE>-PRODUCTO.
   append DB_ULN_ZBT_COMPONT TO DB_UTB_ZBT_COMPONT.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_COMPONT-COMPONENTE = <FS_DELETE>-BUSINESS_KEY-COMPONENTE.
    DB_DLN_ZBT_COMPONT-PRODUCTO = <FS_DELETE>-BUSINESS_KEY-PRODUCTO.

    append DB_DLN_ZBT_COMPONT TO DB_DTB_ZBT_COMPONT.
...
* * DB Deletes
  delete ZBT_COMPONT FROM TABLE DB_DTB_ZBT_COMPONT.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZBT_COMPONT FROM TABLE DB_ITB_ZBT_COMPONT
...
* * DB Updates
  update ZBT_COMPONT FROM TABLE DB_UTB_ZBT_COMPONT.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-COMPONENTE.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_COMPONENTE_PERSIST.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->COMPONENTE = I_BUSINESS_KEY-COMPONENTE.
