...
package com.distriqt.extension.customresources
{
	...
	public final class CustomResources extends EventDispatcher
	{
		...
		private static const ERROR_SINGLETON		: String = "The singleton has already been created. Use CustomResources.service to access the functionality";
		...
		/**
		 * The singleton instance of the CustomResources class.
