class ZCB_ESTADOHIER_PERSIST definition
  public
  inheriting from CL_OS_CA_COMMON
  abstract
  create public .

*"* public components of class ZCB_ESTADOHIER_PERSIST
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      ...
      !I_NEXT_ESTADO type ZBT_ID_NEXT_ESTADO
    returning
      value(RESULT) type ref to ZCL_ESTADOHIER_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_ESTADOHIER_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_ESTADOHIER_PERSIST .
  types:
    begin of TYP_BUSINESS_KEY ,
      ESTADO type ZBT_ID_ESTADO ,
      NEXT_ESTADO type ZBT_ID_NEXT_ESTADO ,
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_ESTADOHIER_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_ESTADOHIER_PERSIST IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 051402
*      IMPORTING I_ESTADO TYPE ZBT_ID_ESTADO
*      IMPORTING I_NEXT_ESTADO TYPE ZBT_ID_NEXT_ESTADO
*      RETURNING RESULT TYPE REF TO ZCL_ESTADOHIER_PERSIST
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-ESTADO = I_ESTADO.
  BUSINESS_KEY-NEXT_ESTADO = I_NEXT_ESTADO.
*>
...
*<  Generated from mapping:
          ...
          THE_OBJECT->NEXT_ESTADO = I_NEXT_ESTADO.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_ESTADO = BUSINESS_KEY-ESTADO
                 I_NEXT_ESTADO = BUSINESS_KEY-NEXT_ESTADO
...
*<Generated from mapping:
  E_BUSINESS_KEY-ESTADO  = I_DB_DATA-ESTADO.
  E_BUSINESS_KEY-NEXT_ESTADO  = I_DB_DATA-NEXT_ESTADO.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_ESTADOHIER_PERSIST,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-NEXT_ESTADO = THE_OBJECT->NEXT_ESTADO.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZBT_ESTADO_HIER'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ESTADO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'NEXT_ESTADO'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_ESTADO_HIER'.
    MAP_ATT_INFO-FIELD_NAME1  = 'NEXT_ESTADO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_ESTADOHIER_PERSIST.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->ESTADO,
             THE_OBJECT->NEXT_ESTADO.
*>
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_ESTADO_HIER.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_ESTADO_HIER> type ZBT_ESTADO_HIER.
*>

*< Generated from mapping:
  select * from ZBT_ESTADO_HIER
           up to I_UPTO rows
...
*   * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZBT_ESTADO_HIER'
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_ESTADO_HIER>.

*< Generated from mapping:
    DB_DATA-ESTADO = <FS_DB_ZBT_ESTADO_HIER>-ESTADO.
    DB_DATA-NEXT_ESTADO = <FS_DB_ZBT_ESTADO_HIER>-NEXT_ESTADO.
*>
...
*< Generated from mapping:
  select * from ZBT_ESTADO_HIER
           ...
           where ZBT_ESTADO_HIER~ESTADO = I_BUSINESS_KEY_TAB-ESTADO
             and ZBT_ESTADO_HIER~NEXT_ESTADO =
             I_BUSINESS_KEY_TAB-NEXT_ESTADO.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-ESTADO = BUSINESS_KEY-ESTADO.
    <FS_OBJECT_DATA>-NEXT_ESTADO = BUSINESS_KEY-NEXT_ESTADO.
*>
...
* * ZBT_ESTADO_HIER: internal tables for mass operation
  data DB_ITB_ZBT_ESTADO_HIER type STANDARD TABLE OF ZBT_ESTADO_HIER.
  data DB_UTB_ZBT_ESTADO_HIER type STANDARD TABLE OF ZBT_ESTADO_HIER.
  data DB_DTB_ZBT_ESTADO_HIER type STANDARD TABLE OF ZBT_ESTADO_HIER.

* * ZBT_ESTADO_HIER: headlines for tables
  data DB_ILN_ZBT_ESTADO_HIER type ZBT_ESTADO_HIER.
  data DB_ULN_ZBT_ESTADO_HIER type ZBT_ESTADO_HIER.
  data DB_DLN_ZBT_ESTADO_HIER type ZBT_ESTADO_HIER.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_ESTADO_HIER-ESTADO = <FS_INSERT>-ESTADO.
   DB_ILN_ZBT_ESTADO_HIER-NEXT_ESTADO = <FS_INSERT>-NEXT_ESTADO.
   append DB_ILN_ZBT_ESTADO_HIER to DB_ITB_ZBT_ESTADO_HIER.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_ESTADO_HIER-ESTADO = <FS_UPDATE>-ESTADO.
   DB_ULN_ZBT_ESTADO_HIER-NEXT_ESTADO = <FS_UPDATE>-NEXT_ESTADO.
   append DB_ULN_ZBT_ESTADO_HIER TO DB_UTB_ZBT_ESTADO_HIER.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_ESTADO_HIER-ESTADO = <FS_DELETE>-BUSINESS_KEY-ESTADO.
    DB_DLN_ZBT_ESTADO_HIER-NEXT_ESTADO =
    <FS_DELETE>-BUSINESS_KEY-NEXT_ESTADO.

    append DB_DLN_ZBT_ESTADO_HIER TO DB_DTB_ZBT_ESTADO_HIER.
...
* * DB Deletes
  delete ZBT_ESTADO_HIER FROM TABLE DB_DTB_ZBT_ESTADO_HIER.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZBT_ESTADO_HIER'.
  endif.

* * DB Inserts
  insert ZBT_ESTADO_HIER FROM TABLE DB_ITB_ZBT_ESTADO_HIER
...
* * DB Updates
  update ZBT_ESTADO_HIER FROM TABLE DB_UTB_ZBT_ESTADO_HIER.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-ESTADO.
  concatenate COMP_STRING TEMP_STRING into TEMP_STRING.
  COMP_STRING = I_BUSINESS_KEY-NEXT_ESTADO.
  concatenate COMP_STRING TEMP_STRING into TEMP_STRING.
*>
...
*<  Generated from mapping:
  ...
  THE_OBJECT->NEXT_ESTADO = I_OBJECT_DATA-NEXT_ESTADO.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_ESTADOHIER_PERSIST.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->ESTADO = I_BUSINESS_KEY-ESTADO.
  NEW_OBJECT->NEXT_ESTADO = I_BUSINESS_KEY-NEXT_ESTADO.
* >
