class ZCB_USUARIO_PERSIST definition
  public
...
public section.
*"* public components of class ZCB_USUARIO_PERSIST
*"* do not include other source files here!!!

  methods CREATE_PERSISTENT
    importing
      !I_IS_ASSIGNED type ZBT_IS_ASSIGNED optional
      !I_IS_DEVELOPER type ZBT_IS_DEVELOPER optional
      !I_IS_REPORTER type ZBT_IS_REPORTER optional
      !I_IS_TESTER type ZBT_IS_TESTER optional
      !I_MAIL type ZBT_EMAIL optional
      !I_USUARIO type XUBNAME
    returning
      value(RESULT) type ref to ZCL_USUARIO_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_USUARIO_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_USUARIO_PERSIST .
  types:
  ...
  types:
    begin of TYP_DB_DATA ,
      IS_ASSIGNED type ZBT_IS_ASSIGNED ,
      IS_DEVELOPER type ZBT_IS_DEVELOPER ,
      IS_REPORTER type ZBT_IS_REPORTER ,
      IS_TESTER type ZBT_IS_TESTER ,
      MAIL type ZBT_EMAIL ,
      USUARIO type XUBNAME ,
    end of TYP_DB_DATA .
  types:
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_USUARIO_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_USUARIO_PERSIST IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_USUARIO TYPE XUBNAME
*      IMPORTING I_IS_ASSIGNED TYPE ZBT_IS_ASSIGNED
*      IMPORTING I_IS_DEVELOPER TYPE ZBT_IS_DEVELOPER
*      IMPORTING I_IS_REPORTER TYPE ZBT_IS_REPORTER
*      IMPORTING I_IS_TESTER TYPE ZBT_IS_TESTER
*      IMPORTING I_MAIL TYPE ZBT_EMAIL
*      RETURNING RESULT TYPE REF TO ZCL_USUARIO_PERSIST
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-USUARIO = I_USUARIO.
*>
...
*<  Generated from mapping:
          THE_OBJECT->USUARIO = I_USUARIO.
          THE_OBJECT->IS_ASSIGNED = I_IS_ASSIGNED.
          THE_OBJECT->IS_DEVELOPER = I_IS_DEVELOPER.
          THE_OBJECT->IS_REPORTER = I_IS_REPORTER.
          THE_OBJECT->IS_TESTER = I_IS_TESTER.
          THE_OBJECT->MAIL = I_MAIL.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_USUARIO = BUSINESS_KEY-USUARIO
...
*<Generated from mapping:
  E_BUSINESS_KEY-USUARIO  = I_DB_DATA-USUARIO.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_USUARIO_PERSIST,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-IS_ASSIGNED = THE_OBJECT->IS_ASSIGNED.
    OBJECT_DATA_ITEM-IS_DEVELOPER = THE_OBJECT->IS_DEVELOPER.
    OBJECT_DATA_ITEM-IS_REPORTER = THE_OBJECT->IS_REPORTER.
    OBJECT_DATA_ITEM-IS_TESTER = THE_OBJECT->IS_TESTER.
    OBJECT_DATA_ITEM-MAIL = THE_OBJECT->MAIL.
    OBJECT_DATA_ITEM-USUARIO = THE_OBJECT->USUARIO.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'IS_ASSIGNED'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_USUARIO'.
    MAP_ATT_INFO-FIELD_NAME1  = 'IS_ASSIGNED'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'IS_DEVELOPER'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_USUARIO'.
    MAP_ATT_INFO-FIELD_NAME1  = 'IS_DEVELOPER'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'IS_REPORTER'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_USUARIO'.
    MAP_ATT_INFO-FIELD_NAME1  = 'IS_REPORTER'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'IS_TESTER'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_USUARIO'.
    MAP_ATT_INFO-FIELD_NAME1  = 'IS_TESTER'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'MAIL'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_USUARIO'.
    MAP_ATT_INFO-FIELD_NAME1  = 'MAIL'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'USUARIO'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_USUARIO'.
    MAP_ATT_INFO-FIELD_NAME1  = 'USUARIO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_USUARIO_PERSIST.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->IS_ASSIGNED,
             THE_OBJECT->IS_DEVELOPER,
             THE_OBJECT->IS_REPORTER,
             THE_OBJECT->IS_TESTER,
             THE_OBJECT->MAIL,
             THE_OBJECT->USUARIO.
*>
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_USUARIO.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_USUARIO> type ZBT_USUARIO.
*>

*< Generated from mapping:
  select * from ZBT_USUARIO
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_USUARIO>.

*< Generated from mapping:
    DB_DATA-IS_ASSIGNED = <FS_DB_ZBT_USUARIO>-IS_ASSIGNED.
    DB_DATA-IS_DEVELOPER = <FS_DB_ZBT_USUARIO>-IS_DEVELOPER.
    DB_DATA-IS_REPORTER = <FS_DB_ZBT_USUARIO>-IS_REPORTER.
    DB_DATA-IS_TESTER = <FS_DB_ZBT_USUARIO>-IS_TESTER.
    DB_DATA-MAIL = <FS_DB_ZBT_USUARIO>-MAIL.
    DB_DATA-USUARIO = <FS_DB_ZBT_USUARIO>-USUARIO.
*>
...
*< Generated from mapping:
  select * from ZBT_USUARIO
           ...
           where ZBT_USUARIO~USUARIO = I_BUSINESS_KEY_TAB-USUARIO.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-USUARIO = BUSINESS_KEY-USUARIO.
*>
...
* * ZBT_USUARIO: internal tables for mass operation
  data DB_ITB_ZBT_USUARIO type STANDARD TABLE OF ZBT_USUARIO.
  data DB_UTB_ZBT_USUARIO type STANDARD TABLE OF ZBT_USUARIO.
  data DB_DTB_ZBT_USUARIO type STANDARD TABLE OF ZBT_USUARIO.

* * ZBT_USUARIO: headlines for tables
  data DB_ILN_ZBT_USUARIO type ZBT_USUARIO.
  data DB_ULN_ZBT_USUARIO type ZBT_USUARIO.
  data DB_DLN_ZBT_USUARIO type ZBT_USUARIO.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_USUARIO-IS_ASSIGNED = <FS_INSERT>-IS_ASSIGNED.
   DB_ILN_ZBT_USUARIO-IS_DEVELOPER = <FS_INSERT>-IS_DEVELOPER.
   DB_ILN_ZBT_USUARIO-IS_REPORTER = <FS_INSERT>-IS_REPORTER.
   DB_ILN_ZBT_USUARIO-IS_TESTER = <FS_INSERT>-IS_TESTER.
   DB_ILN_ZBT_USUARIO-MAIL = <FS_INSERT>-MAIL.



   DB_ILN_ZBT_USUARIO-USUARIO = <FS_INSERT>-USUARIO.
   append DB_ILN_ZBT_USUARIO to DB_ITB_ZBT_USUARIO.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_USUARIO-IS_ASSIGNED = <FS_UPDATE>-IS_ASSIGNED.
   DB_ULN_ZBT_USUARIO-IS_DEVELOPER = <FS_UPDATE>-IS_DEVELOPER.
   DB_ULN_ZBT_USUARIO-IS_REPORTER = <FS_UPDATE>-IS_REPORTER.
   DB_ULN_ZBT_USUARIO-IS_TESTER = <FS_UPDATE>-IS_TESTER.
   DB_ULN_ZBT_USUARIO-MAIL = <FS_UPDATE>-MAIL.



   DB_ULN_ZBT_USUARIO-USUARIO = <FS_UPDATE>-USUARIO.
   append DB_ULN_ZBT_USUARIO TO DB_UTB_ZBT_USUARIO.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_USUARIO-USUARIO = <FS_DELETE>-BUSINESS_KEY-USUARIO.

    append DB_DLN_ZBT_USUARIO TO DB_DTB_ZBT_USUARIO.
...
* * DB Deletes
  delete ZBT_USUARIO FROM TABLE DB_DTB_ZBT_USUARIO.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZBT_USUARIO FROM TABLE DB_ITB_ZBT_USUARIO
...
* * DB Updates
  update ZBT_USUARIO FROM TABLE DB_UTB_ZBT_USUARIO.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-USUARIO.
...
*<  Generated from mapping:
  THE_OBJECT->IS_ASSIGNED = I_OBJECT_DATA-IS_ASSIGNED.
  THE_OBJECT->IS_DEVELOPER = I_OBJECT_DATA-IS_DEVELOPER.
  THE_OBJECT->IS_REPORTER = I_OBJECT_DATA-IS_REPORTER.
  THE_OBJECT->IS_TESTER = I_OBJECT_DATA-IS_TESTER.
  THE_OBJECT->MAIL = I_OBJECT_DATA-MAIL.
  THE_OBJECT->USUARIO = I_OBJECT_DATA-USUARIO.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_USUARIO_PERSIST.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->USUARIO = I_BUSINESS_KEY-USUARIO.
* >
