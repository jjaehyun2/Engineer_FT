...
package org.igniterealtime.xiff.data.sharedgroups
{
	...
	public class SharedGroupsExtensionTest
	{
		...
		{
			var nameSpace:String = "http://www.jivesoftware.org/protocol/sharedgroup";
			var elementName:String = "sharedgroup";
			
			var ext:SharedGroupsExtension = new SharedGroupsExtension();
