class ZCB_BUGTYPE_PERSIST definition
  public
  inheriting from CL_OS_CA_COMMON
  abstract
  create public .

*"* public components of class ZCB_BUGTYPE_PERSIST
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      ...
      !I_NROBJ type NROBJ optional
    returning
      value(RESULT) type ref to ZCL_BUGTYPE_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_BUGTYPE_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_BUGTYPE_PERSIST .
  types:
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_BUGTYPE_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_BUGTYPE_PERSIST IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 051402
*      IMPORTING I_BUGTYPE TYPE ZBT_ID_BUGTYPE
*      IMPORTING I_NROBJ TYPE NROBJ
*      RETURNING RESULT TYPE REF TO ZCL_BUGTYPE_PERSIST
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-BUGTYPE = I_BUGTYPE.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_BUGTYPE = BUSINESS_KEY-BUGTYPE
...
*<Generated from mapping:
  E_BUSINESS_KEY-BUGTYPE  = I_DB_DATA-BUGTYPE.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_BUGTYPE_PERSIST,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-NROBJ = THE_OBJECT->NROBJ.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_TYPE'.
    MAP_ATT_INFO-FIELD_NAME1  = 'BUGTYPE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'NROBJ'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_TYPE'.
    MAP_ATT_INFO-FIELD_NAME1  = 'NROBJ'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_BUGTYPE_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_BUG_TYPE.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_BUG_TYPE> type ZBT_BUG_TYPE.
*>

*< Generated from mapping:
  select * from ZBT_BUG_TYPE
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_BUG_TYPE>.

*< Generated from mapping:
    DB_DATA-BUGTYPE = <FS_DB_ZBT_BUG_TYPE>-BUGTYPE.
    DB_DATA-NROBJ = <FS_DB_ZBT_BUG_TYPE>-NROBJ.
*>
...
*< Generated from mapping:
  select * from ZBT_BUG_TYPE
           ...
           where ZBT_BUG_TYPE~BUGTYPE = I_BUSINESS_KEY_TAB-BUGTYPE.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-BUGTYPE = BUSINESS_KEY-BUGTYPE.
*>
...
* * ZBT_BUG_TYPE: internal tables for mass operation
  data DB_ITB_ZBT_BUG_TYPE type STANDARD TABLE OF ZBT_BUG_TYPE.
  data DB_UTB_ZBT_BUG_TYPE type STANDARD TABLE OF ZBT_BUG_TYPE.
  data DB_DTB_ZBT_BUG_TYPE type STANDARD TABLE OF ZBT_BUG_TYPE.

* * ZBT_BUG_TYPE: headlines for tables
  data DB_ILN_ZBT_BUG_TYPE type ZBT_BUG_TYPE.
  data DB_ULN_ZBT_BUG_TYPE type ZBT_BUG_TYPE.
  data DB_DLN_ZBT_BUG_TYPE type ZBT_BUG_TYPE.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_BUG_TYPE-NROBJ = <FS_INSERT>-NROBJ.


   DB_ILN_ZBT_BUG_TYPE-BUGTYPE = <FS_INSERT>-BUGTYPE.
   append DB_ILN_ZBT_BUG_TYPE to DB_ITB_ZBT_BUG_TYPE.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_BUG_TYPE-NROBJ = <FS_UPDATE>-NROBJ.


   DB_ULN_ZBT_BUG_TYPE-BUGTYPE = <FS_UPDATE>-BUGTYPE.
   append DB_ULN_ZBT_BUG_TYPE TO DB_UTB_ZBT_BUG_TYPE.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_BUG_TYPE-BUGTYPE = <FS_DELETE>-BUSINESS_KEY-BUGTYPE.

    append DB_DLN_ZBT_BUG_TYPE TO DB_DTB_ZBT_BUG_TYPE.
...
* * DB Deletes
  delete ZBT_BUG_TYPE FROM TABLE DB_DTB_ZBT_BUG_TYPE.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZBT_BUG_TYPE FROM TABLE DB_ITB_ZBT_BUG_TYPE
...
* * DB Updates
  update ZBT_BUG_TYPE FROM TABLE DB_UTB_ZBT_BUG_TYPE.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-BUGTYPE.
...
*<  Generated from mapping:
  ...
  THE_OBJECT->NROBJ = I_OBJECT_DATA-NROBJ.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_BUGTYPE_PERSIST.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->BUGTYPE = I_BUSINESS_KEY-BUGTYPE.
* >
