package tetragon.core.au.events
{
	 ...
	 */	
	public class AUStatusUpdateErrorEvent extends ErrorEvent
	{
		/**
		...
		public function AUStatusUpdateErrorEvent(type:String, bubbles:Boolean=false, cancelable:Boolean=false, text:String = "", id:int = 0, subErrorID:int = 0 )
		{
		...
		{
			return new AUStatusUpdateErrorEvent(type, bubbles, cancelable, text, errorID, subErrorID);
		}
