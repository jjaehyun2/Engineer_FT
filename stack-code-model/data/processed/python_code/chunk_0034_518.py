package widgets.PowerOn.busqueda
{
	...
	public class BusquedaDatosOrdenPorTransformador
	{
		...
		public function ejecutar(objeto:Object):void{
			...
			ordenTransTask.url = "https://gisred.chilquinta.cl:6443/arcgis/rest/services/Interrupciones/Interrupciones_clientes/MapServer/6";
		...
		{   
			...
			countTotalAfectadosTask.url = "https://gisred.chilquinta.cl:6443/arcgis/rest/services/Interrupciones/Interrupciones_clientes/MapServer/7";
			...
			function onCountClientesResult(setCountClientes:FeatureSet, token:Object = null):void
			{
				...
				for (var i:Number=0; i < setCountClientes.features.length; i++){
					...
					countTotalClientesTask.url = "https://gisred.chilquinta.cl:6443/arcgis/rest/services/Chilquinta_006/ClientesV2/MapServer/0";
