...
/**
 * Holo light skin for the RadioButtonSkin
 */
public class RadioButtonSkin extends SelectableButtonSkinBase
{
    ...
    [Embed(source="../mobile160/assets/btn_radio_off_holo_light.png")]
    private static const radio_up_160:Class;

    [Embed(source="../mobile160/assets/btn_radio_off_pressed_holo_light.png")]
    private static const radio_down_160:Class;

    [Embed(source="../mobile160/assets/btn_radio_on_holo_light.png")]
    private static const radio_up_selected_160:Class;

    [Embed(source="../mobile160/assets/btn_radio_on_pressed_holo_light.png")]
    private static const radio_down_selected_160:Class;
    ...
    public function RadioButtonSkin()
    {
        ...
        switch (applicationDPI)
        {
            ...
            {
                // default DPI_160
                upIconClass = radio_up_160;
                upSelectedIconClass = radio_up_selected_160;
                downIconClass = radio_down_160;
                downSelectedIconClass = radio_down_selected_160;
