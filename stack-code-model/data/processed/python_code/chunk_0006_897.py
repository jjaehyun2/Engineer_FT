...
INTERFACE /dmo/if_flight_legacy12
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL12
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel12     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING12
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking12    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_12
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_12 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT12
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight12 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id12.
  ...
  TYPES booking_id TYPE /dmo/booking_id12.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id12.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL12, /DMO/BOOKING12, /DMO/BOOK_SUP_12 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code12.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code12,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status12,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel12_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id12.
  INCLUDE TYPE /dmo/booking12_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id12.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id12.
  INCLUDE TYPE /dmo/book_sup_12_data.
