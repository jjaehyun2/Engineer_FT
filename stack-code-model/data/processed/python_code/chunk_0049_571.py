...
import efd.FreeHUD.gui.BasicCooldown

class efd.FreeHUD.gui.GeneralCooldown extends BasicCooldown {
	
	public function GeneralCooldown() {
		super();
	}
	
	// Provided by base
	// This block is not needed for potions, they use predefined image
	...
	//	private var m_CooldownLine:MovieClip; exists
	//	private var m_Gloss:MovieClip; exists
	//	private var m_Background:MovieClip; does not exist
}