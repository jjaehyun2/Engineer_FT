class ZCL_BUGHIER_PERSIST definition
  public
  final
  create protected

  global friends ZCB_BUGHIER_PERSIST .

*"* public components of class ZCL_BUGHIER_PERSIST
...
public section.
  ...
  methods GET_NEXT_BUG
    returning
      value(RESULT) type ZBT_ID_NEXT_BUG
    raising
      CX_OS_OBJECT_NOT_FOUND .
...
protected section.
*"* protected components of class ZCL_BUGHIER_PERSIST
*"* do not include other source files here!!!

  data BUG type ZBT_ID_BUG .
  data NEXT_BUG type ZBT_ID_NEXT_BUG .
  data PRODUCTO type ZBT_ID_PRODUCTO .
private section.
*"* private components of class ZCL_BUGHIER_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_BUGHIER_PERSIST IMPLEMENTATION.
...
***BUILD 051401
     ...
     " raising CX_OS_OBJECT_NOT_FOUND
************************************************************************
* Purpose        : Get Attribute NEXT_BUG
*
* Version        : 2.0
*
* Precondition   : -
