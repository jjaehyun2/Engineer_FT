...
package com.neopets.games.inhouse.brucyBSlots
{
	...
	public class BrucyBSlotsShell extends NP9_GameDocument
	{
		...
		public function BrucyBSlotsShell(pLocalPathwayURL:String = null):void{
			trace ("game itinitialized")
			setupVars();
			super();
		...
		**/
		...
		private function setupVars():void
		{
			...
			mcBIOS.localPathway =  "games/g1121_Slots/";
			mcBIOS.game_datestamp =  "04/29/09";
			mcBIOS.game_timestamp = "2:31PM";
			mcBIOS.game_infostamp = "BlackPawkeetSlots";
			mcBIOS.iBIOSWidth = 650;
			mcBIOS.iBIOSHeight = 600;
			mcBIOS.width = mcBIOS.iBIOSWidth;
			mcBIOS.height = mcBIOS.iBIOSHeight;
			
			objGAME = new MainGame();
