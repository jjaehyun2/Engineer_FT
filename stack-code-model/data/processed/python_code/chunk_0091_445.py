...
package org.igniterealtime.xiff.data.feature
{
	...
	public class FeatureNegotiationExtensionTest
	{
		
		[Test( description="XML element name and namespace checking" )]
		public function testElement():void
		{
			var nameSpace:String = "http://jabber.org/protocol/feature-neg";
			var elementName:String = "feature";
		
			var ext:FeatureNegotiationExtension = new FeatureNegotiationExtension();
