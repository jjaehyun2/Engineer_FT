...
INTERFACE /dmo/if_flight_legacy24
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL24
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel24     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING24
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking24    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_24
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_24 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT24
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id24.
  ...
  TYPES booking_id TYPE /dmo/booking_id24.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id24.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL24, /DMO/BOOKING24, /DMO/BOOK_SUP_24 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code24.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code24,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status24,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel24_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id24.
  INCLUDE TYPE /dmo/booking24_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id24.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id24.
  INCLUDE TYPE /dmo/book_sup_24_data.
