*CLASS zcl_ca_test_ctrlreq_request DEFINITION FOR TESTING
*  DURATION SHORT
*  RISK LEVEL HARMLESS
*.
*  PRIVATE SECTION.
...
*
*
*CLASS zcl_ca_test_ctrlreq_request IMPLEMENTATION.
*
*  METHOD setup.
...
**                                 aiprd           =
*                              request_origem  = ''
*                              trfunction      = zif_ca_ctrlreq_request=>tipo-workbench
*     ).
*
*    go_request = CAST zif_ca_ctrlreq_request(  NEW zcl_ca_ctrlreq_request(
*    i_request               = ''
*    i_cr                    = gw_request_mock-ricef
*    i_projeto               = gw_request_mock-projeto
