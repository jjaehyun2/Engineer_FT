class ZCB_BUG_SUBTYPE_PERSIST definition
  public
...
public section.
*"* public components of class ZCB_BUG_SUBTYPE_PERSIST
*"* do not include other source files here!!!

  methods CREATE_PERSISTENT
    importing
      !I_ICON type ZBT_BUGSTYPE_ICON optional
      !I_SUBTYPE type ZBT_BUGSTYPE
      !I_TYPE type ZBT_ID_BUGTYPE
    returning
      value(RESULT) type ref to ZCL_BUG_SUBTYPE_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_BUG_SUBTYPE_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_BUG_SUBTYPE_PERSIST .
  types:
    begin of TYP_BUSINESS_KEY ,
      SUBTYPE type ZBT_BUGSTYPE ,
      TYPE type ZBT_ID_BUGTYPE ,
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_BUG_SUBTYPE_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_BUG_SUBTYPE_PERSIST IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_SUBTYPE TYPE ZBT_BUGSTYPE
*      IMPORTING I_TYPE TYPE ZBT_ID_BUGTYPE
*      IMPORTING I_ICON TYPE ZBT_BUGSTYPE_ICON
*      RETURNING RESULT TYPE REF TO ZCL_BUG_SUBTYPE_PERSIST
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-SUBTYPE = I_SUBTYPE.
  BUSINESS_KEY-TYPE = I_TYPE.
*>
...
*<  Generated from mapping:
          THE_OBJECT->SUBTYPE = I_SUBTYPE.
          THE_OBJECT->TYPE = I_TYPE.
          THE_OBJECT->ICON = I_ICON.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_SUBTYPE = BUSINESS_KEY-SUBTYPE
                 I_TYPE = BUSINESS_KEY-TYPE
...
*<Generated from mapping:
  E_BUSINESS_KEY-SUBTYPE  = I_DB_DATA-SUBTYPE.
  E_BUSINESS_KEY-TYPE  = I_DB_DATA-TYPE.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_BUG_SUBTYPE_PERSIST,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-ICON = THE_OBJECT->ICON.
    OBJECT_DATA_ITEM-SUBTYPE = THE_OBJECT->SUBTYPE.
    OBJECT_DATA_ITEM-TYPE = THE_OBJECT->TYPE.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ICON'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_STYPE'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ICON'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'SUBTYPE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_STYPE'.
    MAP_ATT_INFO-FIELD_NAME1  = 'SUBTYPE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'TYPE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_STYPE'.
    MAP_ATT_INFO-FIELD_NAME1  = 'TYPE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_BUG_SUBTYPE_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_BUG_STYPE.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_BUG_STYPE> type ZBT_BUG_STYPE.
*>

*< Generated from mapping:
  select * from ZBT_BUG_STYPE
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_BUG_STYPE>.

*< Generated from mapping:
    DB_DATA-ICON = <FS_DB_ZBT_BUG_STYPE>-ICON.
    DB_DATA-SUBTYPE = <FS_DB_ZBT_BUG_STYPE>-SUBTYPE.
    DB_DATA-TYPE = <FS_DB_ZBT_BUG_STYPE>-TYPE.
*>
...
*< Generated from mapping:
  select * from ZBT_BUG_STYPE
           ...
           where ZBT_BUG_STYPE~SUBTYPE = I_BUSINESS_KEY_TAB-SUBTYPE
             and ZBT_BUG_STYPE~TYPE = I_BUSINESS_KEY_TAB-TYPE.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-SUBTYPE = BUSINESS_KEY-SUBTYPE.
    <FS_OBJECT_DATA>-TYPE = BUSINESS_KEY-TYPE.
*>
...
* * ZBT_BUG_STYPE: internal tables for mass operation
  data DB_ITB_ZBT_BUG_STYPE type STANDARD TABLE OF ZBT_BUG_STYPE.
  data DB_UTB_ZBT_BUG_STYPE type STANDARD TABLE OF ZBT_BUG_STYPE.
  data DB_DTB_ZBT_BUG_STYPE type STANDARD TABLE OF ZBT_BUG_STYPE.

* * ZBT_BUG_STYPE: headlines for tables
  data DB_ILN_ZBT_BUG_STYPE type ZBT_BUG_STYPE.
  data DB_ULN_ZBT_BUG_STYPE type ZBT_BUG_STYPE.
  data DB_DLN_ZBT_BUG_STYPE type ZBT_BUG_STYPE.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_BUG_STYPE-ICON = <FS_INSERT>-ICON.




   DB_ILN_ZBT_BUG_STYPE-SUBTYPE = <FS_INSERT>-SUBTYPE.
   DB_ILN_ZBT_BUG_STYPE-TYPE = <FS_INSERT>-TYPE.
   append DB_ILN_ZBT_BUG_STYPE to DB_ITB_ZBT_BUG_STYPE.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_BUG_STYPE-ICON = <FS_UPDATE>-ICON.




   DB_ULN_ZBT_BUG_STYPE-SUBTYPE = <FS_UPDATE>-SUBTYPE.
   DB_ULN_ZBT_BUG_STYPE-TYPE = <FS_UPDATE>-TYPE.
   append DB_ULN_ZBT_BUG_STYPE TO DB_UTB_ZBT_BUG_STYPE.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_BUG_STYPE-SUBTYPE = <FS_DELETE>-BUSINESS_KEY-SUBTYPE.
    DB_DLN_ZBT_BUG_STYPE-TYPE = <FS_DELETE>-BUSINESS_KEY-TYPE.

    append DB_DLN_ZBT_BUG_STYPE TO DB_DTB_ZBT_BUG_STYPE.
...
* * DB Deletes
  delete ZBT_BUG_STYPE FROM TABLE DB_DTB_ZBT_BUG_STYPE.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZBT_BUG_STYPE FROM TABLE DB_ITB_ZBT_BUG_STYPE
...
* * DB Updates
  update ZBT_BUG_STYPE FROM TABLE DB_UTB_ZBT_BUG_STYPE.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-SUBTYPE.
  concatenate COMP_STRING TEMP_STRING into TEMP_STRING.
  COMP_STRING = I_BUSINESS_KEY-TYPE.
  concatenate COMP_STRING TEMP_STRING into TEMP_STRING.
*>
...
*<  Generated from mapping:
  THE_OBJECT->ICON = I_OBJECT_DATA-ICON.
  THE_OBJECT->SUBTYPE = I_OBJECT_DATA-SUBTYPE.
  THE_OBJECT->TYPE = I_OBJECT_DATA-TYPE.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_BUG_SUBTYPE_PERSIST.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->SUBTYPE = I_BUSINESS_KEY-SUBTYPE.
  NEW_OBJECT->TYPE = I_BUSINESS_KEY-TYPE.
* >
