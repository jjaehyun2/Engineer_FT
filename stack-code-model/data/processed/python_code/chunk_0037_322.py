...
package {
    ...
    public class Specs {
        ...
        public static var commands:Array = [
			...
			[".当 %n 点 %n 分时",	"h", 5, "whenTimeUp", 0, 0],
			["-"],
			[".发现人脸离开", "h", 5, "peopleFaceLeave"],
			[".发现人脸来到", "h", 5, "peopleFaceNear"],
			[".当前来人身份", "r", 5, "getPeopleIdentity"],
			[".当前来人名字", "r", 5, "getPeopleName"],
			["-"],
			...
			["-"],
			["做出 %m.expression 的表情", " ", 13, "showExpression", "微笑"],
			["当接收到做 %m.expression 的表情",	"h", 13, "whenShowExpression", "微笑"],
			["-"],
			["%s 包含 %s",	"b", 13, "include"],
			["-"],
