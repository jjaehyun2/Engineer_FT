class ZCB_BUG_ESTHOURS_PERSIST definition
  public
...
public section.
*"* public components of class ZCB_BUG_ESTHOURS_PERSIST
*"* do not include other source files here!!!
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_BUG_ESTHOURS_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_BUG_ESTHOURS_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_BUG_ESTHOURS_PERSIST .
  types:
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_BUG_ESTHOURS_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_BUG_ESTHOURS_PERSIST IMPLEMENTATION.
...
*      IMPORTING I_WRKLOG_CONCEPT TYPE ZBT_WORKLOG_CONCEPT_ID
*      RETURNING RESULT TYPE REF TO ZCL_BUG_ESTHOURS_PERSIST
************************************************************************
...
*< Generated from mapping:
  ...
  BUSINESS_KEY-WRKLOG_CONCEPT = I_WRKLOG_CONCEPT.
*>
...
*<  Generated from mapping:
          ...
          THE_OBJECT->WRKLOG_CONCEPT = I_WRKLOG_CONCEPT.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_PRODUCTO = BUSINESS_KEY-PRODUCTO
                 ...
                 I_WRKLOG_CONCEPT = BUSINESS_KEY-WRKLOG_CONCEPT
...
*<Generated from mapping:
  ...
  E_BUSINESS_KEY-WRKLOG_CONCEPT  = I_DB_DATA-WRKLOG_CONCEPT.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_BUG_ESTHOURS_PERSIST,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-ESTHOURS = THE_OBJECT->ESTHOURS.
*>
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_BUG_ESTHOURS_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_BUG_ESTHOURS.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_BUG_ESTHOURS> type ZBT_BUG_ESTHOURS.
*>

*< Generated from mapping:
  select * from ZBT_BUG_ESTHOURS
           into table DB_DATA_LOCAL_TAB
           for all entries in I_BUSINESS_KEY_TAB
           where ZBT_BUG_ESTHOURS~PRODUCTO = I_BUSINESS_KEY_TAB-PRODUCTO
             and ZBT_BUG_ESTHOURS~BUG = I_BUSINESS_KEY_TAB-BUG
             and ZBT_BUG_ESTHOURS~WRKLOG_CONCEPT =
             I_BUSINESS_KEY_TAB-WRKLOG_CONCEPT.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZBT_BUG_ESTHOURS'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_BUG_ESTHOURS>.

*< Generated from mapping:
    DB_DATA-PRODUCTO = <FS_DB_ZBT_BUG_ESTHOURS>-PRODUCTO.
    DB_DATA-BUG = <FS_DB_ZBT_BUG_ESTHOURS>-BUG.
    DB_DATA-WRKLOG_CONCEPT = <FS_DB_ZBT_BUG_ESTHOURS>-WRKLOG_CONCEPT.
    DB_DATA-ESTHOURS = <FS_DB_ZBT_BUG_ESTHOURS>-ESTHOURS.
*>
...
*<  Generated from mapping:
    ...
    <FS_OBJECT_DATA>-WRKLOG_CONCEPT = BUSINESS_KEY-WRKLOG_CONCEPT.
*>
...
* * ZBT_BUG_ESTHOURS: internal tables for mass operation
  data DB_ITB_ZBT_BUG_ESTHOURS type STANDARD TABLE OF ZBT_BUG_ESTHOURS.
  data DB_UTB_ZBT_BUG_ESTHOURS type STANDARD TABLE OF ZBT_BUG_ESTHOURS.
  data DB_DTB_ZBT_BUG_ESTHOURS type STANDARD TABLE OF ZBT_BUG_ESTHOURS.

* * ZBT_BUG_ESTHOURS: headlines for tables
  data DB_ILN_ZBT_BUG_ESTHOURS type ZBT_BUG_ESTHOURS.
  data DB_ULN_ZBT_BUG_ESTHOURS type ZBT_BUG_ESTHOURS.
  data DB_DLN_ZBT_BUG_ESTHOURS type ZBT_BUG_ESTHOURS.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_BUG_ESTHOURS-ESTHOURS = <FS_INSERT>-ESTHOURS.


   DB_ILN_ZBT_BUG_ESTHOURS-PRODUCTO = <FS_INSERT>-PRODUCTO.
   DB_ILN_ZBT_BUG_ESTHOURS-BUG = <FS_INSERT>-BUG.
   DB_ILN_ZBT_BUG_ESTHOURS-WRKLOG_CONCEPT = <FS_INSERT>-WRKLOG_CONCEPT.
   append DB_ILN_ZBT_BUG_ESTHOURS to DB_ITB_ZBT_BUG_ESTHOURS.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_BUG_ESTHOURS-ESTHOURS = <FS_UPDATE>-ESTHOURS.


   DB_ULN_ZBT_BUG_ESTHOURS-PRODUCTO = <FS_UPDATE>-PRODUCTO.
   DB_ULN_ZBT_BUG_ESTHOURS-BUG = <FS_UPDATE>-BUG.
   DB_ULN_ZBT_BUG_ESTHOURS-WRKLOG_CONCEPT = <FS_UPDATE>-WRKLOG_CONCEPT.
   append DB_ULN_ZBT_BUG_ESTHOURS TO DB_UTB_ZBT_BUG_ESTHOURS.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_BUG_ESTHOURS-PRODUCTO =
    <FS_DELETE>-BUSINESS_KEY-PRODUCTO.
    DB_DLN_ZBT_BUG_ESTHOURS-BUG = <FS_DELETE>-BUSINESS_KEY-BUG.
    DB_DLN_ZBT_BUG_ESTHOURS-WRKLOG_CONCEPT =
    <FS_DELETE>-BUSINESS_KEY-WRKLOG_CONCEPT.

    append DB_DLN_ZBT_BUG_ESTHOURS TO DB_DTB_ZBT_BUG_ESTHOURS.
...
* * DB Deletes
  delete ZBT_BUG_ESTHOURS FROM TABLE DB_DTB_ZBT_BUG_ESTHOURS.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZBT_BUG_ESTHOURS'.
  endif.

* * DB Inserts
  insert ZBT_BUG_ESTHOURS FROM TABLE DB_ITB_ZBT_BUG_ESTHOURS
...
* * DB Updates
  update ZBT_BUG_ESTHOURS FROM TABLE DB_UTB_ZBT_BUG_ESTHOURS.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  ...
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-WRKLOG_CONCEPT.
  concatenate RESULT COMP_STRING into RESULT.
*>
...
*<  Generated from mapping:
  ...
  THE_OBJECT->ESTHOURS = I_OBJECT_DATA-ESTHOURS.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_BUG_ESTHOURS_PERSIST.
...
* < Generated from mapping:
  ...
  NEW_OBJECT->WRKLOG_CONCEPT = I_BUSINESS_KEY-WRKLOG_CONCEPT.
* >
