class ZCL_FDLOG_SHR_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_FDLOG_SHR_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_FDLOG_SHR_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_FDLOG_SHR_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZCL_FDLOG_SHR_ROOT
    raising
...
CLASS ZCL_FDLOG_SHR_AREA IMPLEMENTATION.
