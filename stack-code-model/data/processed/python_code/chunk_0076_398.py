...
package com.neopets.games.inhouse.shenkuuwarrior2
{
	...
	import com.neopets.projects.np10.managers.NP10_EventsManager;
	...
	public class Standalone extends MovieClip
	{
		//--------------------------------------------------------------------------
		// Costants
		//--------------------------------------------------------------------------	
		 ...
		 * 
		 */
		public function Standalone(root:MovieClip)
		{
			super();
			_gameroot = root;
		}
...
import com.neopets.games.inhouse.shenkuuwarrior2;