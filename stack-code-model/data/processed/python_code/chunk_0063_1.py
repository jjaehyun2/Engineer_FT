package qihoo.triplecleangame.protos {
	...
	public dynamic final class CMsgUseItemRequest extends com.netease.protobuf.Message {
		public static const ITEMID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgUseItemRequest.itemID", "itemID", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const ITEMNUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgUseItemRequest.itemNum", "itemNum", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		public static const USEREASON:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("qihoo.triplecleangame.protos.CMsgUseItemRequest.useReason", "useReason", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (itemID$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgUseItemRequest.itemID cannot be set twice.');
					}
					++itemID$count;
				...
				case 2:
					if (itemNum$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgUseItemRequest.itemNum cannot be set twice.');
					}
					++itemNum$count;
				...
				case 3:
					if (useReason$count != 0) {
						throw new flash.errors.IOError('Bad data format: CMsgUseItemRequest.useReason cannot be set twice.');
					}
					++useReason$count;
