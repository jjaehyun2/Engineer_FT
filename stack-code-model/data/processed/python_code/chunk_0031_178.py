package devoron.dataui.propertiescontainer
{
	 ...
	 * @author Devoron
	 */
	public class AbstractLAFForm extends DataContainerForm implements IPropertiesPanelComponent
	{
		private var iconsTable:IconsTable;
		private var iconsTableScP:JScrollPane;
		private var colorsTableScP:JScrollPane;
		private var colorsTable:ColorsTable;
		
		public function AbstractLAFForm(dataContainerName:String = "", dataContainerType:String = "", dataContainerIcon:Icon = null, dataCollectionMode:String = DataContainerForm.SINGLE_COMPONENT_DATA_COLLECTION, dataLiveMode:Boolean = false)
		{
