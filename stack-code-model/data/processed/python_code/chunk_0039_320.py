...
package feathers.extension.ahhenderson.managers.events {
	 ...
	 */
	public class PopUpContentEvent {
		...
		*
		*/
		public static const CONTENT_ITEM_CHANGED:String="CONTENT_ITEM_CHANGED";
		 ...
		 *
		 */
		public static const CONTENT_ITEM_TRIGGERED:String="CONTENT_ITEM_TRIGGERED";
		
		/**
		 * The <code>MenuEvent.MENU_CLOSED</code> event type is dispatched when an <code>IMenu</code> item is closed.
		 *
		 */
		public static const CONTENT_ITEM_CLOSED:String="CONTENT_ITEM_CLOSED";
	}
}