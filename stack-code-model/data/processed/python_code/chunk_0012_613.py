"! <p class="shorttext synchronized" lang="en">Helper class for Message handling</p>
CLASS zcl_sat_message_helper DEFINITION
  ...
  PUBLIC SECTION.
    ...
    "! <p class="shorttext synchronized" lang="en">Prints the currently stored system message</p>
    CLASS-METHODS print_system_message.
    "! <p class="shorttext synchronized" lang="en">Splits string for MESSAGE command</p>
