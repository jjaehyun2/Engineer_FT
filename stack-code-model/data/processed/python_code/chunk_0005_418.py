class ZCL_LISP_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_LISP_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_LISP_SHM_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_LISP_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZCL_LISP_SHM_ROOT
    raising
...
CLASS ZCL_LISP_AREA IMPLEMENTATION.
