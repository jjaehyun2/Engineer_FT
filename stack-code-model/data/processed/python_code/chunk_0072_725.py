...
package starling.animation
{
    ...
    public class Tween extends EventDispatcher implements IAnimatable
    {
		...
		protected var mTransitionFunc:Function;
		protected var mTransitionName:String;
        
		protected var mProperties:Vector.<String>;
		protected var mStartValues:Vector.<Number>;
		protected var mEndValues:Vector.<Number>;

		protected var mOnStart:Function;
		protected var mOnUpdate:Function;
		protected var mOnRepeat:Function;
		protected var mOnComplete:Function;  
        
		protected var mOnStartArgs:Array;
		protected var mOnUpdateArgs:Array;
		protected var mOnRepeatArgs:Array;
		protected var mOnCompleteArgs:Array;
