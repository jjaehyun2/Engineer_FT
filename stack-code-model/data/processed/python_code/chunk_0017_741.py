...
class lcl_zip_writer_test implementation.
  ...
  method list.
    ...
    cl_abap_unit_assert=>assert_equals( act = lt_files_act exp = lt_files_exp ).
  ...
  method encodings.
    ...
    lo_zipw->addx( iv_filename = 'dir/utf8.txt' iv_xdata = lv_xdata ).
    ...
    lo_zipw->addx( iv_filename = 'dir/utf16.txt' iv_xdata = lv_xdata ).
    ...
    cl_abap_conv_out_ce=>create( encoding = '1100' )->convert( " 8859-1
      ...
      importing
        buffer = lv_xdata ).
    lo_zipw->addx( iv_filename = 'dir/plain.txt' iv_xdata = lv_xdata ).
