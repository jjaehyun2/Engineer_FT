CLASS zcl_cts_html DEFINITION
  PUBLIC
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES zif_cts_html.

    ALIASES:
      add          FOR zif_cts_html~add,
      render       FOR zif_cts_html~render,
      is_empty     FOR zif_cts_html~is_empty,
      add_a        FOR zif_cts_html~add_a,
      add_checkbox FOR zif_cts_html~add_checkbox,
      a            FOR zif_cts_html~a,
      icon         FOR zif_cts_html~icon.
...
CLASS zcl_cts_html IMPLEMENTATION.
  ...
  METHOD a.
    ...
    IF iv_opt CA zif_cts_html=>c_html_opt-strong.
      lv_class = lv_class && ' emphasis' ##NO_TEXT.
    ENDIF.
    IF iv_opt CA zif_cts_html=>c_html_opt-cancel.
      lv_class = lv_class && ' attention' ##NO_TEXT.
    ENDIF.
    IF iv_opt CA zif_cts_html=>c_html_opt-crossout.
    ...
    IF iv_act IS NOT INITIAL OR iv_typ = zif_cts_html=>c_action_type-dummy.
      CASE iv_typ.
        WHEN zif_cts_html=>c_action_type-url.
          lv_href  = | href="{ iv_act }"|.
        WHEN zif_cts_html=>c_action_type-sapevent.
          lv_href  = | href="sapevent:{ iv_act }"|.
        WHEN zif_cts_html=>c_action_type-onclick.
          lv_href  = ' href="#"'.
          lv_click = | onclick="{ iv_act }"|.
        WHEN zif_cts_html=>c_action_type-dummy.
          lv_href  = ' href="#"'.
      ENDCASE.
    ENDIF.
  ...
  METHOD add.
    ...
    DATA: lv_type TYPE c,
          lo_html TYPE REF TO zcl_cts_html.
  ...
  METHOD zif_cts_html~add_checkbox.
