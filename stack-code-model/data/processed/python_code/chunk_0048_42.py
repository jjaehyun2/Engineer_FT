...
public dynamic class MenuListComponent extends MenuComponent
{
    ...
    public function set dataSubscriptionKeyword_Inspectable(param1:String) : void
    {
    ...
    public function set numItems_Inspectable(param1:Number) : void
    {
    ...
    public function set verticalSpacing_Inspectable(param1:Number) : void
    {
    ...
    public function set backgroundHeight_Inspectable(param1:Number) : void
    {
    ...
    public function set backgroundWidth_Inspectable(param1:Number) : void
    {
    ...
    public function set backgroundAlpha_Inspectable(param1:Number) : void
    {
    ...
    public function set fixedBackgroundHeight_Inspectable(param1:Boolean) : void
    {
    ...
    public function set reverseOrder(param1:Boolean) : void
    {
    ...
    public function set disableSelection_Inspectable(param1:Boolean) : void
    {
