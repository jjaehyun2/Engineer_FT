class ZCB_BUGHIER_PERSIST definition
  public
  inheriting from CL_OS_CA_COMMON
  abstract
  create public .

*"* public components of class ZCB_BUGHIER_PERSIST
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      ...
      !I_NEXT_BUG type ZBT_ID_NEXT_BUG
      !I_PRODUCTO type ZBT_ID_PRODUCTO
    returning
      value(RESULT) type ref to ZCL_BUGHIER_PERSIST
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class ZCB_BUGHIER_PERSIST
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to ZCL_BUGHIER_PERSIST .
  types:
    begin of TYP_BUSINESS_KEY ,
      BUG type ZBT_ID_BUG ,
      NEXT_BUG type ZBT_ID_NEXT_BUG ,
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class ZCB_BUGHIER_PERSIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCB_BUGHIER_PERSIST IMPLEMENTATION.


method CREATE_PERSISTENT.
***BUILD 051402
*      IMPORTING I_BUG TYPE ZBT_ID_BUG
*      IMPORTING I_NEXT_BUG TYPE ZBT_ID_NEXT_BUG
*      IMPORTING I_PRODUCTO TYPE ZBT_ID_PRODUCTO
*      RETURNING RESULT TYPE REF TO ZCL_BUGHIER_PERSIST
************************************************************************
...
*< Generated from mapping:
  ...
  BUSINESS_KEY-NEXT_BUG = I_NEXT_BUG.
...
*<  Generated from mapping:
          ...
          THE_OBJECT->NEXT_BUG = I_NEXT_BUG.
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_BUG = BUSINESS_KEY-BUG
                 I_NEXT_BUG = BUSINESS_KEY-NEXT_BUG
...
*<Generated from mapping:
  ...
  E_BUSINESS_KEY-NEXT_BUG  = I_DB_DATA-NEXT_BUG.
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_BUGHIER_PERSIST,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-NEXT_BUG = THE_OBJECT->NEXT_BUG.
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_HIER'.
    MAP_ATT_INFO-FIELD_NAME1  = 'BUG'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'NEXT_BUG'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZBT_BUG_HIER'.
    MAP_ATT_INFO-FIELD_NAME1  = 'NEXT_BUG'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_BUGHIER_PERSIST.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZBT_BUG_HIER.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZBT_BUG_HIER> type ZBT_BUG_HIER.
*>

*< Generated from mapping:
  select * from ZBT_BUG_HIER
           up to I_UPTO rows
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZBT_BUG_HIER>.

*< Generated from mapping:
    DB_DATA-BUG = <FS_DB_ZBT_BUG_HIER>-BUG.
    DB_DATA-NEXT_BUG = <FS_DB_ZBT_BUG_HIER>-NEXT_BUG.
    DB_DATA-PRODUCTO = <FS_DB_ZBT_BUG_HIER>-PRODUCTO.
*>
...
*< Generated from mapping:
  select * from ZBT_BUG_HIER
           ...
           where ZBT_BUG_HIER~BUG = I_BUSINESS_KEY_TAB-BUG
             and ZBT_BUG_HIER~NEXT_BUG = I_BUSINESS_KEY_TAB-NEXT_BUG
             and ZBT_BUG_HIER~PRODUCTO = I_BUSINESS_KEY_TAB-PRODUCTO.
*>
...
*<  Generated from mapping:
    ...
    <FS_OBJECT_DATA>-NEXT_BUG = BUSINESS_KEY-NEXT_BUG.
...
* * ZBT_BUG_HIER: internal tables for mass operation
  data DB_ITB_ZBT_BUG_HIER type STANDARD TABLE OF ZBT_BUG_HIER.
  data DB_UTB_ZBT_BUG_HIER type STANDARD TABLE OF ZBT_BUG_HIER.
  data DB_DTB_ZBT_BUG_HIER type STANDARD TABLE OF ZBT_BUG_HIER.

* * ZBT_BUG_HIER: headlines for tables
  data DB_ILN_ZBT_BUG_HIER type ZBT_BUG_HIER.
  data DB_ULN_ZBT_BUG_HIER type ZBT_BUG_HIER.
  data DB_DLN_ZBT_BUG_HIER type ZBT_BUG_HIER.
...
*< Generated from mapping:
   ...
   DB_ILN_ZBT_BUG_HIER-BUG = <FS_INSERT>-BUG.
   DB_ILN_ZBT_BUG_HIER-NEXT_BUG = <FS_INSERT>-NEXT_BUG.
   DB_ILN_ZBT_BUG_HIER-PRODUCTO = <FS_INSERT>-PRODUCTO.
   append DB_ILN_ZBT_BUG_HIER to DB_ITB_ZBT_BUG_HIER.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZBT_BUG_HIER-BUG = <FS_UPDATE>-BUG.
   DB_ULN_ZBT_BUG_HIER-NEXT_BUG = <FS_UPDATE>-NEXT_BUG.
   DB_ULN_ZBT_BUG_HIER-PRODUCTO = <FS_UPDATE>-PRODUCTO.
   append DB_ULN_ZBT_BUG_HIER TO DB_UTB_ZBT_BUG_HIER.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZBT_BUG_HIER-BUG = <FS_DELETE>-BUSINESS_KEY-BUG.
    DB_DLN_ZBT_BUG_HIER-NEXT_BUG = <FS_DELETE>-BUSINESS_KEY-NEXT_BUG.
    DB_DLN_ZBT_BUG_HIER-PRODUCTO = <FS_DELETE>-BUSINESS_KEY-PRODUCTO.

    append DB_DLN_ZBT_BUG_HIER TO DB_DTB_ZBT_BUG_HIER.
...
* * DB Deletes
  delete ZBT_BUG_HIER FROM TABLE DB_DTB_ZBT_BUG_HIER.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZBT_BUG_HIER FROM TABLE DB_ITB_ZBT_BUG_HIER
...
* * DB Updates
  update ZBT_BUG_HIER FROM TABLE DB_UTB_ZBT_BUG_HIER.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  ...
  COMP_STRING = I_BUSINESS_KEY-NEXT_BUG.
  concatenate COMP_STRING TEMP_STRING into TEMP_STRING.
...
*<  Generated from mapping:
  ...
  THE_OBJECT->NEXT_BUG = I_OBJECT_DATA-NEXT_BUG.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_BUGHIER_PERSIST.
...
* < Generated from mapping:
  ...
  NEW_OBJECT->NEXT_BUG = I_BUSINESS_KEY-NEXT_BUG.
