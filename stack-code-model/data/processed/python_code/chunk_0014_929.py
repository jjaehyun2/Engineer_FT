class ZCL_HTTP_MIME_TYPES definition
  public
...
*"* public components of class zCL_HTTP_MIME_TYPES
...
protected section.
*"* protected components of class zCL_HTTP_MIME_TYPES
*"* do not include other source files here!!!
private section.
*"* private components of class zCL_HTTP_MIME_TYPES
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_HTTP_MIME_TYPES IMPLEMENTATION.
ENDCLASS.