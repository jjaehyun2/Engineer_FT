...
INTERFACE /dmo/if_flight_legacy03
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL03
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel03     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING03
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking03    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_03
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_03 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT03
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight03 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id03.
  ...
  TYPES booking_id TYPE /dmo/booking_id03.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id03.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL03, /DMO/BOOKING03, /DMO/BOOK_SUP_03 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code03.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code03,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status03,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel03_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id03.
  INCLUDE TYPE /dmo/booking03_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id03.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id03.
  INCLUDE TYPE /dmo/book_sup_03_data.
