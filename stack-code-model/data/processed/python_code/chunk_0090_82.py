...
public class DragProxy extends UIComponent
{
    ...
    private var dontProcessRelatedObjectEvents : Boolean;
    ...
    public function DragProxy(dragInitiator:IUIComponent,
							  ...
							  dontProcessRelatedObjectEvents : Boolean )
    {
		super();
		...
		this.dontProcessRelatedObjectEvents = dontProcessRelatedObjectEvents;
    }
    ...
    public function showFeedback():void
    {
        ...
        else if ( /*modified*/ /*action == DragManager.NONE  ||*/ action == DragManager.REJECT /*modified*/)
    ...
    {
        /*modified*/
		if ( dontProcessRelatedObjectEvents && event.relatedObject ) return;
		/*modified*/
    ...
    public function mouseUpHandler(event:MouseEvent):void
    {
        ...
        if (target /*modified*//*&& action != DragManager.NONE*//*modified*/ )
        {
        ...
        if (action == DragManager.NONE /*modified*/|| action == DragManager.REJECT  /*modified*/)
        {
