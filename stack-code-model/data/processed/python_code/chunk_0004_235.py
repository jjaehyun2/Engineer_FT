...
INTERFACE /dmo/if_flight_legacy09
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL09
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel09     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING09
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking09    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_09
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_09 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT09
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight09 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id09.
  ...
  TYPES booking_id TYPE /dmo/booking_id09.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id09.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL09, /DMO/BOOKING09, /DMO/BOOK_SUP_09 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code09.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code09,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status09,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel09_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id09.
  INCLUDE TYPE /dmo/booking09_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id09.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id09.
  INCLUDE TYPE /dmo/book_sup_09_data.
