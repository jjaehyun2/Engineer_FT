package kemsky.sql
{
    public class RestrictionEquals implements IRestriction
    {
        ...
        public function RestrictionEquals(attr_name:String, value:*)
        {
        ...
        {
            return "RestrictionEquals{attr_name=" + String(attr_name) + ",param_name=" + String(param_name) + ",params=" + String(params) + "}";
        }
    }
}